package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_2028 = param1.invDigit();
         this.var_2029 = this.var_2028 & 32767;
         this.var_2778 = this.var_2028 >> 15;
         this.var_2779 = 131071;
         this.var_2777 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_194) > 0)
         {
