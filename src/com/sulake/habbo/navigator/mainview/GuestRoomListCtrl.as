package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_608:RoomPopupCtrl;
      
      private var var_615:IScrollbarWindow;
      
      private var var_1186:UserCountRenderer;
      
      private var var_1712:IWindowContainer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_608 = new RoomPopupCtrl(this._navigator,5,-5);
         this.var_1186 = new UserCountRenderer(this._navigator);
      }
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_615 = IScrollbarWindow(this.var_203.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.var_615.scrollV = 0;
         }
         this.var_203.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_190,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_2031,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_222,null,0);
         ...
         this.var_1186.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_608.visible && this.var_3059)
         {
            return;
         }
         ...
         this.var_608.room = _loc4_;
         this.var_608.showPopup(_loc2_);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1712.tags[0];
            this.var_1712.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_3060 - _loc2_.stageX);
         this.var_3060 = _loc2_.stageX;
         this.var_3059 = _loc3_ > 2;
      }
   }
}
