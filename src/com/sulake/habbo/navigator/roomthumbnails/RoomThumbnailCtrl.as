package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2161:IButtonWindow;
      
      private var var_2163:IButtonWindow;
      
      private var var_3005:IWindowContainer;
      
      private var var_3006:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_2162 = IButtonWindow(this.find("bg_tab"));
         this.var_2161 = IButtonWindow(this.find("top_tab"));
         this.var_2163 = IButtonWindow(this.find("obj_tab"));
         this.var_3005 = IWindowContainer(this.find("tile_grid"));
         this.var_3006 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_2162,this.onBgTabButton);
         Util.setProcDirectly(this.var_2161,this.onTopTabButton);
         Util.setProcDirectly(this.var_2163,this.onObjTabButton);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_78.mode = ThumbnailEditorModel.const_37;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_2162,this.var_78.mode != ThumbnailEditorModel.const_37);
         this.setEnabled(this.var_2161,this.var_78.mode != ThumbnailEditorModel.const_63);
         this.setEnabled(this.var_2163,this.var_78.mode != ThumbnailEditorModel.const_34);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_3006;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_78.mode == ThumbnailEditorModel.const_37);
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_3005;
         _loc1_.visible = true;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_71,HabboWindowStyle.const_30,HabboWindowParam.const_64,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_333,HabboWindowStyle.const_46,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_361,HabboWindowStyle.const_46,HabboWindowParam.const_64,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
