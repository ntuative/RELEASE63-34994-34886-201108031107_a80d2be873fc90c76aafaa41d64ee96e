package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_493 = new Timer(500,1);
         this.var_407 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_1161 = param4;
         this.var_2362 = param2;
         this._popupIndentLeft = param3;
         this.var_493.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
         this.var_407.addEventListener(TimerEvent.TIMER,this.onHideTimer);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_493)
         {
            this.var_493.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_493.reset();
            this.var_493 = null;
         }
         if(this.var_407)
         {
            this.var_407.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_407.reset();
            this.var_407 = null;
         }
      }
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_61 == null)
         {
            this.var_61 = IWindowContainer(this._navigator.getXmlWindow(this.var_1161));
         ...
         this.var_61.x = _loc2_.x + this.var_2362 + param1.width;
