package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_320:MainViewCtrl;
      
      private var var_653:RoomInfoViewCtrl;
      
      private var var_1210:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_459:Tabs;
      ...
      private var var_2459:Array;
      
      private var var_2460:RoomThumbnailRenderer;
      
      private var var_1117:GuestRoomPasswordInput;
      
      private var var_335:GuestRoomDoorbell;
      
      private var var_1211:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2459 = new Array();
         ...
         this.var_320 = new MainViewCtrl(this);
         this.var_653 = new RoomInfoViewCtrl(this);
         this.var_1210 = new RoomCreateViewCtrl(this);
         this.var_2460 = new RoomThumbnailRenderer(this);
         this.var_1117 = new GuestRoomPasswordInput(this);
         this.var_335 = new GuestRoomDoorbell(this);
         this.var_459 = new Tabs(this);
         this.var_1211 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_361,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_320.startSearch(Tabs.const_292,Tabs.const_605,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_320.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_320.startSearch(Tabs.const_281,Tabs.const_315);
         this.var_459.getTab(Tabs.const_281).tabPageDecorator.tabSelected();
      }
