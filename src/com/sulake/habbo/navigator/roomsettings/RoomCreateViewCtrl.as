package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1287:TextFieldManager;
      
      private var var_45:Array;
      
      private var var_1288:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_681 = new Timer(100);
         this.var_681.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         ...
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_36,540,"t"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_36,512,"w"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_36,396,"x"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_36,440,"y"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_36,456,"z"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_36,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_681)
         {
            this.var_681.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_681.reset();
            this.var_681 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1288.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1986 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1986 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_203 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_62 = IItemListWindow(this.var_203.findChildByName("item_list"));
         ...
         this.var_1287 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_203.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_203.desktop,this.var_203.width,this.var_203.height);
         this.var_203.x = _loc4_.x;
         this.var_203.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1287.goBackToInitialState();
         this.var_1287.input.textBackgroundColor = 4294967295;
         this.var_1288 = this.var_45[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         {
            if(this._navigator.sessionData.hasUserRight("fuse_use_vip_room_layouts",HabboClubLevelEnum.const_36))
            {
               _loc5_ = null;
            }
            else
      ...
      private function isAllowed(param1:RoomLayout) : Boolean
      {
         switch(param1.requiredClubLevel)
         {
            ...
            case HabboClubLevelEnum.const_36:
               return this._navigator.sessionData.hasUserRight("fuse_use_vip_room_layouts",HabboClubLevelEnum.const_36);
            default:
               return false;
         }
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_71,HabboWindowStyle.const_30,HabboWindowParam.const_64,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1287.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_203.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_203.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1287.getText();
         var _loc3_:String = "model_" + this.var_1288.name;
