package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1063:uint = 11;
      ...
      private var var_200:IHabboHelp;
      ...
      private var var_446:FramerateTracker = null;
      
      private var var_271:LatencyTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_446 = new FramerateTracker();
         this.var_271 = new LatencyTracker();
         this.var_652 = new LagWarningLogger();
         this.var_445 = new ToolbarClickTracker(this);
         this.var_1505 = new Array(const_1063);
         var _loc4_:int = 0;
         while(_loc4_ < const_1063)
         {
            this.var_1505[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1957,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1801,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1851,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_957,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1188,String(0));
         }
         ...
         if(!disposed)
         {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_372,this.onZoomToggle);
               }
            ...
            if(this.var_216)
            {
               if(!this.var_216.disposed)
               {
                  ...
                  Component(this.var_216).events.removeEventListener(HabboFriendListTrackingEvent.const_593,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_200)
            {
               if(!this.var_200.disposed)
               {
                  this.var_200.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_200.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_200.release(new IIDHabboHelp());
               this.var_200 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_226,this.onRoomAdClick);
            ...
            {
               this.var_319.stop();
               this.var_319.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_319 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._configuration)
         {
            if(this.var_271 != null)
            {
               this.var_271.configuration = this._configuration;
            }
            if(this.var_272 != null)
            {
               this.var_272.configuration = this._configuration;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_2030);
            if(this._configuration)
            {
               ...
               if(this.var_446 != null)
               {
                  this.var_446.configure(this._configuration);
               }
               if(this.var_445 != null)
               {
                  this.var_445.configure(this._configuration);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_808,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_314,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_760,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_69,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_663,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_271 != null)
            {
               this.var_271.communication = this._communication;
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_760)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1908);
         }
         else if(param1.type == HabboHotelViewEvent.const_663)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1903);
         }
         else if(param1.type == HabboHotelViewEvent.const_69)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1902);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1900);
               break;
            case HabboCommunicationEvent.const_808:
               this.trackLoginStep(HabboLoginTrackingStep.const_1864,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_314:
               this.trackLoginStep(HabboLoginTrackingStep.const_314);
               break;
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this._configuration)
            {
               if(this._configuration.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1505)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1327);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1327,this.onCoreRunning);
         }
      }
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_372,this.onZoomToggle);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_216).events.addEventListener(HabboFriendListTrackingEvent.const_593,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_593:
      ...
      {
         this.var_200 = param2 as IHabboHelp;
         this.var_200.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_200.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2453)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1783);
            this.var_2453 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1188,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_957,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_226,this.onRoomAdClick);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_322.events.addEventListener(AdEvent.const_538,this.onRoomAdLoad);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         if(param1.type == RoomEngineEvent.const_181)
         {
            if(this.var_1840 < 1)
            {
               if(!this.var_319)
               {
                  this.var_319 = new Timer(60000,1);
                  this.var_319.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_319.start();
               }
            }
         }
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_446)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_446.frameRate),_loc2_);
                  ++this.var_1840;
               }
            }
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1841;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1841);
         }
         if(this.var_536 > -1 && _loc2_ - this.var_536 > 15000)
         {
            ++this.var_1839;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1839);
         }
         this.var_536 = _loc2_;
         if(this.var_272 != null)
         {
            this.var_272.update(param1,this.var_536);
         }
         if(this.var_271 != null)
         {
            this.var_271.update(param1,this.var_536);
         }
         if(this.var_446 != null)
         {
            this.var_446.trackUpdate(param1,this,this.var_536);
         }
         if(this.var_652 != null)
         {
            this.var_652.update(this.var_536);
         }
      }
   }
}
