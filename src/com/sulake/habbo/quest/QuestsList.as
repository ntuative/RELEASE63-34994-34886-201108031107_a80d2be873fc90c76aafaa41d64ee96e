package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1539:int = 5;
      
      private static const const_1541:int = 10;
      
      private static const const_1542:int = 10;
      
      private static const const_1540:int = 30;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_804 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_804.toggle();
         this.var_1923 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1542.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1542[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_615 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_62.spacing = const_1541;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1542;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1539;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1540;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1923 && !this.var_1924)
            {
               this.var_1923 = false;
