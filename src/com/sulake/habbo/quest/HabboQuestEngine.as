package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1511:int = 5;
      
      private static const const_1513:int = 800;
      
      private static const const_1510:int = 15;
      
      private static const const_1512:int = 300;
      ...
      private var var_1232:QuestController;
      
      private var var_659:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1232 = new QuestController(this);
         this.var_659 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1511);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_387.events.removeEventListener(BadgeImageReadyEvent.const_179,this.var_659.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_387.events.addEventListener(BadgeImageReadyEvent.const_179,this.var_659.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_48)
         {
            ...
            {
               this.var_1232.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_659.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1232.questTracker.isVisible();
      }
