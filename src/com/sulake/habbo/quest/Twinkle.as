package com.sulake.habbo.quest
{
   ...
   public class Twinkle implements AnimationObject, IDisposable
   {
      ...
      private static const const_1078:Array = [1,2,3,4,5,6,5,4,3,2,1];
      ...
      {
         this.var_1342 = new Point(Math.round(Math.random() * 0),Math.round(Math.random() * 0));
      }
