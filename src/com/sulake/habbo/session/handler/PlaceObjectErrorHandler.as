package com.sulake.habbo.session.handler
{
   ...
   public class PlaceObjectErrorHandler extends BaseHandler
   {
      ...
      private function onPlaceObjectError(param1:IMessageEvent) : void
      {
         ...
         {
            case PlaceObjectErrorEnum.const_305:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_279:
               _loc4_ = "null";
               break;
            ...
            case PlaceObjectErrorEnum.const_232:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_280:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_300:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_309:
               _loc4_ = "null";
               break;
            default:
               return;
