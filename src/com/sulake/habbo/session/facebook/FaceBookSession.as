package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1173:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1751:String = "sendAccessTokenToServer";
      
      private static const const_1752:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1751,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1752,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1173);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1173);
         }
      }
