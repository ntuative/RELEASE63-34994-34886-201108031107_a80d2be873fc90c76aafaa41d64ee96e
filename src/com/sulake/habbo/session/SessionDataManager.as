package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_3107:Array;
      
      private var var_2033:GroupDetailsView;
      ...
      private var var_692:ProductDataParser;
      ...
      private var var_2031:UserTagManager;
      
      private var var_1045:BadgeImageManager;
      
      private var var_1308:HabboGroupInfoManager;
      
      private var var_1046:IgnoredUsersManager;
      ...
      private var var_1307:FaceBookSession;
      
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_3107 = [];
         this.var_2031 = new UserTagManager(events);
         this.var_1308 = new HabboGroupInfoManager(this,events);
         this.var_1046 = new IgnoredUsersManager(this);
         this.var_1307 = new FaceBookSession();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_339)
         {
            this.var_339.removeEventListener(FurnitureDataParser.const_135,this.onFurnitureReady);
            this.var_339.dispose();
            this.var_339 = null;
         }
         if(this.var_692)
         {
            this.var_692.removeEventListener(ProductDataParser.const_135,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1045 = new BadgeImageManager(assets,events,this._configuration,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_2031.communication = this._communication;
         this.var_1308.communication = this._communication;
         this.var_1307.communication = this._communication;
         this.var_1046.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_339)
         {
            ...
            this.var_339 = new FurnitureDataParser(this.var_572,this._wallItems,this.var_571,this._localization);
            this.var_339.addEventListener(FurnitureDataParser.const_135,this.onFurnitureReady);
      ...
      private function onFurnitureReady(param1:Event = null) : void
      {
         var _loc2_:* = null;
         this.var_339.removeEventListener(FurnitureDataParser.const_135,this.onFurnitureReady);
         for each(_loc2_ in this.var_1047)
         {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2030 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2515 = _loc3_.respectTotal;
         this.var_1309 = _loc3_.respectLeft;
         this.var_848 = _loc3_.petRespectLeft;
         this.var_754 = _loc3_.figure;
         this._gender = _loc3_.sex;
         this.var_1819 = _loc3_.realName;
         this.var_1046.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            this.var_754 = _loc2_.figure;
            this._gender = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_754,this._gender));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2781 = _loc2_.isOpen;
         this.var_2780 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_2030 >= SecurityLevelEnum.const_1268;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_2031.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1045.getBadgeImage(param1);
      }
      
      public function requestBadgeImage(param1:String) : BitmapData
      {
         return this.var_1045.getBadgeImage(param1,BadgeImageManager.const_1226,false);
      }
      
      public function getBadgeImageWithInfo(param1:String) : BadgeInfo
      {
         return this.var_1045.getBadgeImageWithInfo(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_2033 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1308.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_2033.showGroupDetails(param1);
         }
      }
      
      public function getGroupDetails(param1:int) : HabboGroupDetails
      {
         return this.var_1308.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1308.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1045.getBadgeImage(param1,BadgeImageManager.const_1394);
      }
      ...
      {
         return this.var_1046.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_1046.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_1046.unignoreUser(param1);
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || this.var_1309 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to user: " + param1);
         }
         _loc2_.send(new RespectUserMessageComposer(param1));
         this.var_1309 = this.var_1309 - 1;
      }
      
      public function givePetRespect(param1:int) : void
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_848 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_848 = this.var_848 - 1;
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return this.var_572.getValue(param1.toString());
      }
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(param1 && this.var_1306.indexOf(param1) == -1)
         {
            this.var_1306.push(param1);
         }
         if(!this._configuration)
         {
            return false;
         ...
         if(this.var_692 == null)
         {
            ...
            this.var_692 = new ProductDataParser(_loc2_,this.var_1413);
            this.var_692.addEventListener(ProductDataParser.const_135,this.onProductsReady);
         }
         return false;
      }
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         {
            if(this.var_1047.indexOf(param1) == -1)
            {
               this.var_1047.push(param1);
            }
            return null;
         }
         var _loc2_:Array = this.var_572.getValues();
