package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2397:int = 2500;
      ...
      private var var_874:UserDataManager;
      ...
      {
         this.var_1084 = new Map();
         super();
         this._roomId = param1;
         this._roomCategory = param2;
         this._habboTracking = param3;
         this._password = param4;
         this.var_2569 = param5;
         this.var_874 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_874.connection = param1;
         }
      }
      ...
      {
         if(this._state == RoomSessionEvent.const_284 && this._connection != null)
         {
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1635));
         this.var_1084.add(this.var_1635,getTimer());
         ++this.var_1635;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1084.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2397)
            {
      ...
      {
         return this.var_874 as IUserDataManager;
      }
