package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_519:int = 70;
      ...
      private var var_254:HabboNotificationItem;
      ...
      private var var_1194:uint;
      
      private var var_1193:uint;
      
      private var var_1485:uint;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1798 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1798 = 15;
         }
         this.var_1796 = this._window.height;
         this.var_1486 = 4;
         this.var_778 = 0;
         this._state = name_4;
      ...
      {
         if(param1.badgeId != this.var_254.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_666:
               ...
               _loc2_ = Number(this.var_1194) / Number(this.var_964["time_fade_in"]);
               if(this.var_1194 > int(this.var_964["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1054:
               ...
               if(this.var_1485 > int(this.var_964["time_display"]) && !this.var_1797)
               {
                  this.startFadeOut();
               }
               break;
            case const_1053:
               ...
               _loc3_ = 1 - Number(this.var_1193) / Number(this.var_964["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1193 > int(this.var_964["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1798;
         if(this._window.height < this.var_1796)
         {
            this._window.height = this.var_1796;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1779;
         this._window.y = this.var_1486;
      }
