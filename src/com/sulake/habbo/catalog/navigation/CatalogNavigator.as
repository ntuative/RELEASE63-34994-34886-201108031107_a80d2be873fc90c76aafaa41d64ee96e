package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_3143:String = "magic.credits";
      
      private var var_3115:String = "magic.pixels";
      
      private var var_3114:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_3115);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_3114,true);
      }
      ...
      private function buildIndexNode(param1:NodeData, param2:int) : ICatalogNode
      {
         ...
         param2++;
         for each(_loc5_ in param1.method_4)
         {
