package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_701:uint = 1;
      ...
      private var var_1302:IRoomSession;
      ...
      private var var_1073:IAvatarRenderManager;
      ...
      private var var_250:ICatalogNavigator;
      
      private var var_112:Purse;
      
      private var var_104:RecyclerLogic;
      
      private var var_154:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_204:PurchaseConfirmationDialog;
      
      private var var_225:ChargeConfirmationDialog;
      ...
      private var var_2772:Boolean = true;
      
      private var var_2773:Boolean = true;
      
      private var var_2026:Boolean = false;
      
      private var var_2774:GiftWrappingConfiguration;
      
      private var var_1304:ClubGiftController;
      
      private var var_570:ClubBuyController;
      
      private var var_847:ClubExtendController;
      ...
      private var var_1592:IDragAndDropDoneReceiver;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1073)
         {
            this.var_1073.release(new IIDAvatarRenderManager());
            this.var_1073 = null;
         }
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionEvent.const_81,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_2040);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_387.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_112.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_112.getActivityPointsForType(param1.activityPointType))
         {
         ...
         if(param1 is Offer)
         {
            if(this.var_204 == null || this.var_204.disposed)
            {
               this.var_204 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_204.showOffer(this,this._roomEngine,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_570.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2775 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_387.loadProductData(this);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1073 = param2 as IAvatarRenderManager;
      }
      ...
      {
         if(this._roomEngine != null && this._configuration != null && this._configuration.getKey("catalog.furniture.animation","AnimationAction") == "true")
         {
            if(this.var_691 == null)
            {
               this.var_691 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_805 || !this.var_250 || !this.var_250.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1044 = -1;
            this.var_844 = param1;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_250.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this._configuration.getKey("client.credits.embed.enabled","AnimationAction") == "true";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_387.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_387.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_65)
         {
            _loc3_ = this.var_387.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_112.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_112.getActivityPointsForType(ActivityPointTypeEnum.PIXEL)));
         var _loc1_:int = 0;
         if(!this.var_112.hasClubLeft)
         {
            _loc2_ = "catalog.purse.club.join";
         }
         else
         {
            if(this.var_112.isVIP)
            {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_112.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_112.clubPeriods));
         }
      ...
      {
         if(param1.iconId == HabboToolbarIconEnum.CATALOGUE && param1.type == HabboToolbarEvent.const_48)
         {
            this.toggleCatalog();
         }
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(this.mainWindowVisible())
         {
            ...
            if(this.var_104 != null && this.getCurrentLayoutCode() == "recycler")
            {
               this.var_104.activate();
            }
         }
         else
         {
         ...
         this.setupInventoryForRecycler(this.var_104.active && this.mainWindowVisible());
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_250 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_701) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2104;
         this.hideMainWindow();
         ...
         _loc4_.setParamFlag(WindowParam.const_302,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_76:
               this.var_2026 = param1.session.isPrivateRoom;
               this.var_1302 = param1.session;
               if(this.var_104 != null)
               {
                  this.var_104.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_81:
               ...
               if(this.var_104 != null)
               {
                  this.var_104.setRoomSessionActive(false);
               }
         }
      }
      ...
      {
         this.var_104 = new RecyclerLogic(this,this._windowManager);
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_154 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_570 == null)
         {
            this.var_570 = new ClubBuyController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_847 == null)
         {
            this.var_847 = new ClubExtendController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1591 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_250.buildCatalogIndex(_loc2_);
         if(this.var_844 && this.var_844 != "")
         {
            this.var_250.openPage(this.var_844);
            this.var_844 = "";
            this.var_1044 = -1;
         }
         else if(this.var_1044 > -1)
         {
            this.var_250.openPageById(this.var_1044,this.var_2027);
            this.var_1044 = -1;
            this.var_2027 = -1;
            this.var_844 = "";
         }
         else if(this.var_1591 && this.var_2775)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_250.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1880));
         }
         else
         {
            this.var_250.loadFrontPage();
         }
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_112.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2772 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1401);
         }
         this.var_2772 = false;
         if(this.var_225 != null && !this.var_225.disposed)
         {
            this.var_225.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_130,this.var_112.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_112.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2773 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1215);
         }
         this.var_2773 = false;
         if(this.var_225 != null && !this.var_225.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_331,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_886)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_383,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_112.activityPoints = _loc2_.points;
         this.updatePurse();
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_331,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_383,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_112.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_112.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_112.isVIP = _loc2_.isVIP;
         this.var_112.pastClubDays = _loc2_.pastClubDays;
         this.var_112.pastVipDays = _loc2_.pastVipDays;
         this.var_112.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1233 ? true : false;
         this.updatePurse();
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_104 == null)
         {
            return;
         }
         this.var_104.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         this.var_104.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         this.var_104.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_154 != null)
         {
            this.var_154.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_154 != null)
         {
            this.var_154.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_154 != null)
         {
            this.var_154.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2774 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_154.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_225 == null || this.var_225.disposed)
         {
            this.var_225 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_225.showChargeInfo(_loc2_);
      }
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1302 || !this.var_1302.isRoomOwner)
         {
            return false;
         }
         ...
         switch(_loc2_.productType)
         {
            case ProductTypeEnum.const_198:
               _loc3_ = false;
               break;
            case ProductTypeEnum.const_350:
               _loc3_ = false;
         }
         return _loc3_;
      }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_211);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_227);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_214);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1305 && param1.type == RoomEngineObjectEvent.const_169)
         {
            ...
            this.var_64 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_846);
            _loc5_ = this.var_1592;
            if(_loc5_ != null)
            {
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         if(this.var_64 != null && this.var_64.productClassId == param1.classId)
         {
            if(this.var_64.roomCategory == this._roomEngine.activeRoomCategory && this.var_64.roomId == this._roomEngine.activeRoomId)
            {
               ...
               {
                  case FurniCategory.const_347:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_227);
                  ...
                  case FurniCategory.const_356:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_211);
                  ...
                  case FurniCategory.const_326:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_214);
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_701);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_691 != null)
         {
            this.var_691.updatePreviewRoomView();
         }
      }
   }
}
