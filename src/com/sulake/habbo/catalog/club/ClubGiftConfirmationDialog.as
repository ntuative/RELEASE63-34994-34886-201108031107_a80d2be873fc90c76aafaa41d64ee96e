package com.sulake.habbo.catalog.club
{
   ...
   public class ClubGiftConfirmationDialog
   {
      ...
      public function showConfirmation() : void
      {
         ...
         this.var_103.productContainer.initProductIcon(this.var_27.roomEngine);
      }
      
      private function method_9() : String
      {
         var _loc1_:* = null;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "select_button":
               this.var_27.confirmSelection(this.var_103.localizationId);
               break;
