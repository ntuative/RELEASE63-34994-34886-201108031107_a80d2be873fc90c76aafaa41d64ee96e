package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2085:String = "ctlg_";
       
      
      protected var var_2292:XML;
      ...
      private var var_609:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1415:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_609 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1416);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1416);
      }
      ...
      {
         var _loc2_:String = const_2085 + param1;
         ...
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2292) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1877:
               if(this.var_1415 == null)
               {
                  this.var_1415 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_39.push(this.var_1415);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1769:
               ...
               break;
            case CatalogWidgetEnum.const_2035:
            ...
            case CatalogWidgetEnum.const_1912:
               ...
               break;
            case CatalogWidgetEnum.const_1915:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_609.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_609 != null)
         {
            return this.var_609.dispatchEvent(param1);
         }
         return false;
      }
