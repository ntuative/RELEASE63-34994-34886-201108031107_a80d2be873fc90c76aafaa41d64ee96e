package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1105.removeEventListener(WindowKeyboardEvent.const_199,this.windowKeyEventProcessor);
            this.var_1105 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1105 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1105 != null)
         {
            this.var_1105.addEventListener(WindowKeyboardEvent.const_199,this.windowKeyEventProcessor);
         }
         return true;
      }
