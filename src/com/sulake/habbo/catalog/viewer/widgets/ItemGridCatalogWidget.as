package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_520:IItemGridWindow;
      ...
      protected var var_231:Boolean = true;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_815,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_209,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_765,this.deActivateScrollbar);
      ...
      override public function init() : Boolean
      {
         ...
         this.var_520 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_936 >= 0 && this.var_936 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_936];
                  this.loadGraphics(_loc4_);
                  _loc4_.productContainer.grid = this;
               }
               ++this.var_936;
               if(this.var_936 >= _loc2_)
               {
                  this.resetTimer();
                  break;
               }
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2196) as IWindowContainer;
         this.var_520.addGridItem(_loc2_);
         ...
         if(param1.pricingModel == Offer.const_630)
         {
            ++this.var_2213;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_2213);
         }
      }
