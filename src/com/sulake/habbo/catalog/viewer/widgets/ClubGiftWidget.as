package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_260)
         {
            this.var_260 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_260)
         {
            return;
         }
         var _loc4_:IBitmapWrapperWindow = this.var_260.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc4_)
         {
            return;
         }
         ...
         this.var_260.setGlobalPosition(_loc6_.subtract(new Point(this.var_260.width / 2,this.var_260.height / 2)));
         this.var_260.visible = true;
         this.var_260.activate();
      }
