package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_523:IDisplayObjectWrapper;
      
      private var var_1736:Point;
      
      private var var_522:IItemGridWindow;
      
      private var var_1454:IScrollbarWindow;
      
      protected var var_2196:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_956 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1170 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_95 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_192 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_192 != null)
         {
            this.var_192.visible = false;
            this.var_523 = this.var_192.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_523 != null && _loc3_ != null)
            {
               this.var_192.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_523.width,this.var_523.height);
               if(_loc4_ != null)
               {
                  this.var_523.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1736 = new Point(this.var_95.x,this.var_95.y);
         this.var_522 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1454 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_522 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_2196 = _loc1_.content as XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_956.text = _loc4_;
         this.var_1170.text = _loc5_;
         this.var_956.height = this.var_956.textHeight + 5;
         this.var_1170.y = this.var_956.y + this.var_956.height;
         this.var_1170.height = Math.max(130,this.var_1170.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               ...
               case Offer.const_411:
                  _loc9_ = _loc2_.productContainer.firstProduct;
                  if(this.var_192 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_78 || _loc9_.productType == ProductTypeEnum.const_65 || _loc9_.productType == ProductTypeEnum.const_198)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_78:
                        if(_loc8_ != null && this.var_523 != null)
                        {
                     ...
                     case ProductTypeEnum.const_198:
                        ...
                        else
                        {
                           ...
                           _loc6_ = new BitmapData(this.var_95.width,this.var_95.height,false,_loc15_);
                           _loc16_ = null;
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 _loc18_.setDirection(AvatarSetType.const_56,3);
                                 _loc18_.initActionAppends();
                                 _loc18_.appendAction(AvatarAction.const_344,AvatarAction.const_617);
                                 _loc18_.appendAction(AvatarAction.const_354,_loc9_.productClassId);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_95);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2304)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2304 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_95 != null && true)
         {
            ...
            if(this.var_95.bitmap == null)
            {
               this.var_95.bitmap = new BitmapData(this.var_95.width,this.var_95.height,true,16777215);
            }
            this.var_95.bitmap.fillRect(this.var_95.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_95.width - param1.width) / 2,(this.var_95.height - param1.height) / 2);
            this.var_95.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_95.invalidate();
            this.var_95.x = this.var_1736.x;
            this.var_95.y = this.var_1736.y;
            if(param3 != null)
            {
               this.var_95.x += param3.x;
               this.var_95.y += param3.y;
            }
         }
         if(param2)
         {
