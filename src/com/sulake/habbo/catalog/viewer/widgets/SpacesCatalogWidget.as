package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1569:String = "default";
      ...
      private var var_1570:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1022 = this.parseElements(_loc2_.floors.pattern);
         this.var_1285 = this.parseElements(_loc2_.walls.pattern);
         this.var_1284 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_1022)
                  {
                     _loc11_ = this.var_1022[_loc10_];
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1569,this.var_1570,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1283[this.var_468];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1569);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1286[this.var_470];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this._landscapeOffers[this.var_469];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1570);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_680[this.var_470];
         var _loc3_:Array = this.var_1022[_loc2_];
         if(_loc3_ != null && this.var_473 >= 0)
         {
            _loc11_ = _loc3_[this.var_473];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1286[this.var_470];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_825[this.var_468];
         var _loc6_:Array = this.var_1285[_loc5_];
         if(_loc6_ != null && this.var_472 >= 0)
         {
            _loc13_ = _loc6_[this.var_472];
            if(_loc13_ != null)
            {
               this.var_1569 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1283[this.var_468];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_824[this.var_469];
         var _loc9_:Array = this.var_1284[_loc8_];
         if(_loc9_ != null && this.var_471 >= 0)
         {
            _loc15_ = _loc9_[this.var_471];
            if(_loc15_ != null)
            {
               this.var_1570 = _loc15_;
            }
         }
         var _loc10_:Offer = this._landscapeOffers[this.var_469];
         if(_loc10_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_114:
               ...
               if(this.var_470 < 0)
               {
                  this.var_470 = this.var_680.length - 1;
               }
               if(this.var_470 >= this.var_680.length)
               {
                  this.var_470 = 0;
               }
               this.var_473 = 0;
               this.var_1024 = 0;
               _loc5_ = this.var_680[this.var_470];
               _loc6_ = this.var_1022[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_1024 = _loc6_.length;
               }
            ...
            case const_238:
               ...
               if(this.var_468 < 0)
               {
                  this.var_468 = this.var_825.length - 1;
               }
               if(this.var_468 == this.var_825.length)
               {
                  this.var_468 = 0;
               }
               this.var_472 = 0;
               this.var_1021 = 0;
               _loc7_ = this.var_825[this.var_468];
               _loc8_ = this.var_1285[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_1021 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_469 < 0)
               {
                  this.var_469 = this.var_824.length - 1;
               }
               if(this.var_469 >= this.var_824.length)
               {
                  this.var_469 = 0;
               }
               this.var_471 = 0;
               this.var_1023 = 0;
               _loc9_ = this.var_824[this.var_469];
               _loc10_ = this.var_1284[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_1023 = _loc10_.length;
               }
