package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogObjectMover implements IGetImageListener
   {
      ...
      private static const const_486:String = "CatalogOverlaySprite";
      ...
      {
         if(param1 == null || this._mainContainer == null || this._mainContainer.desktop == null || this.method_3() != null)
         {
            return;
         }
         var _loc2_:Sprite = this._mainContainer.desktop.getDisplayObject() as Sprite;
         var _loc3_:Sprite = new Sprite();
         _loc3_.name = const_486;
      ...
      private function method_3() : Sprite
      {
         ...
         return _loc1_.getChildByName(const_486) as Sprite;
      }
      
      private function moveOverlaySprite(param1:int, param2:int) : void
      {
         var _loc3_:Sprite = this.method_3();
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         if(this._mainContainer == null || this._mainContainer.desktop == null || this.method_3() == null)
         {
            return;
         }
         var _loc1_:Sprite = this._mainContainer.desktop.getDisplayObject() as Sprite;
         var _loc2_:Sprite = _loc1_.getChildByName(const_486) as Sprite;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         _loc1_.removeChild(_loc1_.getChildByName(const_486));
      }
   }
}
