package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private static const const_1545:String = "poster";
       
      
      public const const_2343:int = 1;
      
      public const const_2331:int = 2;
      
      public const const_2409:int = 3;
      ...
      private var var_349:Map;
      
      private var var_2965:int;
      
      private var var_2477:int = -1;
      
      private var var_2970:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_301);
            this.var_301 = null;
         }
         if(this.var_349 != null)
         {
            this.disposeOffers(this.var_349);
            this.var_349 = null;
         }
         this._disposed = true;
      }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_204)
         {
            this.var_204 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_204.showConfirmation(param1,param2);
      }
      ...
      public function requestOffers(param1:int, param2:int, param3:String, param4:int) : void
      {
         ...
         this.var_2967 = param2;
         this.var_2558 = param3;
         this.var_2966 = param4;
         if(this._catalog)
         {
      ...
      {
         this.requestOffers(this.var_2968,this.var_2967,this.var_2558,this.var_2966);
      }
      ...
      {
         if(!this.var_301 || !this._catalog || !this._catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = this.var_301.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
         ...
         this.showConfirmation(this.const_2343,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         var _loc1_:Array = this.var_349.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_349.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_525)
            {
               this.var_349.remove(_loc2_);
               _loc3_.dispose();
            }
         }
         if(this._catalog)
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            this.var_301.add(_loc4_.offerId,_loc5_);
         }
         this.var_2969 = _loc3_.totalItemsFound;
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2965 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_349.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            item = this.var_301.remove(parser.requestedOfferId);
            if(item != null)
            {
               item.dispose();
            }
         ...
         {
            updateItem = this.var_301.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               this.var_301.add(parser.offerId,updateItem);
            }
            this.var_301.remove(parser.requestedOfferId);
            this.showConfirmation(this.const_2331,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_349.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2481 || param1.furniTypeId != this.var_2478)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1545)
               {
                  _loc2_ = true;
               }
            }
      ...
      public function getNameLocalizationKey(param1:IMarketPlaceOfferData) : String
      {
         ...
         if(param1 != null)
         {
            ...
            else if(param1.furniType == MarketPlaceOfferData.const_114)
            {
