package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1131:int = 0;
      
      private static const const_483:int = 1;
      ...
      {
         return this.var_720 != const_1131;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_2096 != RecyclerStatusMessageEvent.const_1225;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_720 == const_483;
      }
      ...
      {
         this.var_720 = const_1130;
         this.var_138 = new Array(const_236);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_2096)
         {
            case RecyclerStatusMessageEvent.const_1865:
               this.var_720 = const_483;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1225:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1996:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1206:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1959:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         {
            oldObjectData = this.var_138[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_236)
            {
               oldObjectData = this.var_138[newSlotId];
         ...
         this.var_138[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_138[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_138[param1].id))
         {
            return;
         }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_138.length < const_236)
         {
            return false;
         }
         var _loc1_:int = 0;
