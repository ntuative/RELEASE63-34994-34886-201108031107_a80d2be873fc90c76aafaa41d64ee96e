package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1183:IDropMenuWindow;
      
      private var var_549:ITextFieldWindow;
      
      private var var_664:Boolean = true;
      
      private var var_1030:ICheckBoxWindow;
      
      private var var_1576:ICheckBoxWindow;
      
      private var var_1577:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_415));
         Logger.log("BEGINNING TO SHOW: " + this.var_415);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1781;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_415);
         if(param1.flatId != this.var_415)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_415);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1183 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1183);
         this.var_1183.procedure = this.onSelectTemplate;
         this.var_1030 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1576 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1577 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_999,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_664 || this.var_549.text == "")
         {
            this.var_35.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1030.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1931,_loc2_,this.var_549.text,"",""));
         if(this.var_1576.isSelected || this.var_1577.isSelected || this.var_1030.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1576.isSelected,this.var_1577.isSelected,this.var_1030.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1940);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1907);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1183.selection];
         if(_loc3_ != null)
         {
            this.var_664 = false;
