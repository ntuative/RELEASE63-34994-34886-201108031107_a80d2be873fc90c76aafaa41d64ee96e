package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1250:IDropMenuWindow;
      ...
      private var var_998:OffenceCategoryData;
      
      private var var_997:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1249 = IButtonWindow(this.var_35.getXmlWindow("modact_offence"));
         this.var_1251 = IButtonWindow(this.var_35.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1783;
         ...
         this.var_1250 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1250);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_998 != null;
         if(this.var_997 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_997.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_998 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_998.offences,this.var_1249,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_35.initMsg.offenceCategories,this.var_1251,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1983;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModAlertMessageComposer(this.var_1550,this.var_549.text,this.var_1549));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_998 = this.var_35.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_997 = this.var_998.offences[_loc3_];
         this.var_549.text = this.var_997.msg;
         this.var_664 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModKickMessageComposer(this.var_1550,this.var_549.text,this.var_1549));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1250.selection < 0)
         {
            this.var_35.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_35.connection.send(new ModBanMessageComposer(this.var_1550,this.var_549.text,this.getBanLength(),this.var_1549));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1250.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1249.destroy();
            this.var_1249 = null;
         }
         if(this.var_1251 != null)
         {
            this.var_1251.destroy();
            this.var_1251 = null;
         }
         this.var_1250 = null;
         this.var_549 = null;
