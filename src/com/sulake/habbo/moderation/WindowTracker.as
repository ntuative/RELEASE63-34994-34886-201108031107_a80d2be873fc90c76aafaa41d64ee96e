package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1988:int = 1;
      
      public static const const_1815:int = 2;
      
      public static const const_1242:int = 3;
      ...
      public static const const_1983:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1781:int = 9;
       
      
      private var var_2178:Dictionary;
      
      public function WindowTracker()
      {
         this.var_2178 = new Dictionary();
         super();
      }
      ...
      {
         var _loc2_:Dictionary = this.var_2178[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_2178[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
