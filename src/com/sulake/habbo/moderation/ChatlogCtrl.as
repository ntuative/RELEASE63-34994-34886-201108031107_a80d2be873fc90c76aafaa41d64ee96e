package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1152:Array = [];
      
      private static var var_2219:int = 1000;
      
      private static var var_1151:Array = [];
      
      private static var var_2218:int = 200;
      ...
      private var var_2035:IMessageComposer;
      ...
      private var var_2217:Dictionary;
      
      private var var_558:Timer;
      
      private var var_1714:Map;
      ...
      {
         this.var_937 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_938 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         this.var_558 = new Timer(1000,1);
         ...
         this.var_35.connection.send(this.var_2035);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1152.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_938.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1152.length < var_2219)
         {
            ...
            param1.width = this.var_938.width;
            param1.height = this.var_938.height;
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1151.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_937.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1151.length < var_2218)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_937.width;
            param1.height = this.var_937.height;
            var_1151.push(param1);
         }
         else
         {
            param1.dispose();
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_2217[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1714.getValue(param2.chatterName))
            {
               this.var_1714.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1714.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1713)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1715)
         {
