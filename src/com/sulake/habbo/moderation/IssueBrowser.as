package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2392:String = "open_issues";
      
      private const const_2390:String = "picked_issues";
      
      private const const_2408:String = "closed_issues";
      ...
      private var var_395:IIssueBrowserView;
      
      private var var_2067:IIssueBrowserView;
      
      private var var_2065:IIssueBrowserView;
      
      private var var_2066:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_290 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_290.numTabItems)
            {
               _loc5_ = this.var_290.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_47,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_290 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_290 == null || this.var_290.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_290.selector.getSelectableByName("open_issues");
         this.var_290.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_395 == _loc2_)
         {
            return;
         }
         ...
         this.var_395.view.width = this.var_290.container.width;
         this.var_395.view.height = this.var_290.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2391:
               if(this.var_2067 == null)
               {
                  this.var_2067 = new MyIssuesView(this.issueManager,this,this.var_290.container);
               }
               return this.var_2067;
            case this.const_2392:
               if(this.var_2065 == null)
               {
                  this.var_2065 = new OpenIssuesView(this.issueManager,this,this.var_290.container);
               }
               return this.var_2065;
            case this.const_2390:
               if(this.var_2066 == null)
               {
                  this.var_2066 = new PickedIssuesView(this.issueManager,this,this.var_290.container);
               }
