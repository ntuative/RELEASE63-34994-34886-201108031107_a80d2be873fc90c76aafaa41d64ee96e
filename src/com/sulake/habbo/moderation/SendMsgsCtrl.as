package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Msg To: " + this.var_1783;
      ...
      {
         return WindowTracker.const_1815;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.messageTemplates[this.var_1183.selection];
         if(_loc3_ != null)
         {
            this.var_664 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModMessageMessageComposer(this.var_1550,this.var_549.text,this.var_1549));
         this.dispose();
      }
