package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1983:int = 200;
      ...
      {
         this.var_826 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_826.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1025.length < var_1983)
         {
            ...
            param1.width = this.var_826.width;
            param1.height = this.var_826.height;
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1572)
         {
