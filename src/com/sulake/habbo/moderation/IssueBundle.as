package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_895:IssueMessageData = null;
      
      private var var_894:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2568 = param2.pickerUserId;
         this.var_2984 = param2.pickerUserName;
         this.var_1573 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1366 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1367;
         }
         if(this.var_895 == null || param1.timeStamp < this.var_895.timeStamp)
         {
            this.var_895 = param1;
         }
         if(this.var_894 == null || param1.priority > this.var_894.timeStamp)
         {
            this.var_894 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1366 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1367;
            }
            if(this.var_895 == _loc2_)
            {
               this.var_895 = null;
            }
            if(this.var_894 == _loc2_)
            {
               this.var_894 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_894;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_895;
         if(_loc2_ == null)
         {
