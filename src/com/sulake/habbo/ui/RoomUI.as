package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1219:IRoomWidgetFactory;
      ...
      private var var_1221:IHabboHelp;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1221.release(new IIDHabboHelp());
            this.var_1221 = null;
         }
         ...
         if(this.var_1220)
         {
            this.var_1220.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1220 = null;
         }
         this.var_1484 = null;
         ...
         if(this.var_321)
         {
            ...
            {
               _loc1_ = this.var_321.getKey(0) as String;
               _loc2_ = this.var_321.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1484 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_322.events.addEventListener(InterstitialEvent.const_642,this.interstitialCompleteEventHandler);
            this.var_322.events.addEventListener(InterstitialEvent.const_649,this.adEventHandler);
            this.var_322.events.addEventListener(AdEvent.const_538,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1221 = param2 as IHabboHelp;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            this.var_15.events.addEventListener(RoomSessionEvent.const_284,this.roomSessionStateEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_207,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_566,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserBadgesEvent.const_151,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_126,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_155,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_609,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_644,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_548,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_305,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_279,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_845,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1321,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1369,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_289,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_280,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_300,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_761,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_963,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_658,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_162,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_560,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDanceEvent.const_156,this.roomSessionEventHandler);
         }
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_284:
               this.createDesktop(param1.session);
               break;
            case RoomSessionEvent.const_76:
               this._toolbar.setToolbarState(HabboToolbarEnum.const_746);
               break;
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_279:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_845:
            ...
            case RoomSessionErrorMessageEvent.const_855:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_1032:
               errorMessage = "${room.error.pets.forbidden_in_flat}";
               break;
            case RoomSessionErrorMessageEvent.const_761:
               errorMessage = "${room.error.pets.no_free_tiles}";
               break;
            case RoomSessionErrorMessageEvent.const_963:
      ...
      private function interstitialCompleteEventHandler(param1:InterstitialEvent) : void
      {
         ...
         var _loc2_:String = this.getRoomIdentifier(this._interstitialRoomId,this.var_2501);
      ...
      private function onUserDefinedRoomEventsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1220 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_858,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_536,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_503,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_68,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_810,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_928,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_626,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_1016,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_285,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_858)
         {
            if(this.var_15 != null)
            {
               this.var_15.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_503 || param1.type == RoomEngineEvent.const_536)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_181:
               ...
               _loc3_.disposeWidget(RoomWidgetEnum.const_532);
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_947);
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_769);
               ...
               if(this.var_1513 != RoomDesktop.const_533)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_323,this.var_1513);
               }
               if(this.var_322 != null)
               {
                  this.var_322.showRoomAd(param1.roomId,param1.roomCategory);
               }
            ...
            case RoomEngineEvent.const_360:
               ...
               break;
            case RoomEngineRoomColorEvent.const_810:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         if(_loc3_.showInterstitial())
         {
            ...
            this.var_2501 = param1.roomCategory;
         }
         else
         {
            this.var_1514 = false;
         }
         this.var_321.add(_loc2_,_loc3_);
         return _loc3_;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = this.var_321.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_323);
            if(_loc3_ != RoomDesktop.const_533)
            {
      ...
      {
         return this.var_321.getValue(param1) as RoomDesktop;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_321.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
