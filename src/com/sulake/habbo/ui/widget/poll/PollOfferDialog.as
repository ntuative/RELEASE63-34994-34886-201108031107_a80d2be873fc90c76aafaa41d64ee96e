package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_2034:String = "POLL_OFFER_STATE_OK";
      
      public static const const_880:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_110:String = "POLL_OFFER_STATE_UNKNOWN";
      ...
      {
         if(this._state != const_110)
         {
            return;
         }
         this._state = const_2034;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_958,this._id));
      }
      ...
      private function onCancel(param1:WindowEvent) : void
      {
         ...
         this._state = const_880;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_581,this._id));
