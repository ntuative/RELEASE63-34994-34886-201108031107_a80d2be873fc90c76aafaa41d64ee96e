package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1602:int = 16;
      
      private static const const_696:int = 4;
      
      private static const const_1604:uint = 14342874;
      
      private static const const_1601:uint = 3815994;
      
      private static const const_1603:uint = 2085362;
      
      private static const const_1598:uint = 39616;
      
      private static const const_1608:uint = 10513106;
      
      private static const const_1599:uint = 8734654;
      
      private static const const_1606:uint = 9094430;
      
      private static const const_1609:uint = 6200576;
      
      private static const const_1605:String = "happiness";
      
      private static const const_1596:String = "experience";
      
      private static const const_1600:String = "energy";
      
      private static const const_1597:int = 250;
      
      private static const const_1098:int = 25;
      
      private static const const_1097:int = 5;
      ...
      private var var_220:PetCommandTool;
      ...
      {
         if(this.var_55 == null || this.var_49 == null || this.var_107 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_49.width,this.var_107.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_49.width < this.var_107.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1605,param1.nutrition,param1.nutritionMax,const_1598,const_1603);
         this.updateStateElement(const_1596,param1.experience,param1.experienceMax,const_1599,const_1608);
         this.updateStateElement(const_1600,param1.energy,param1.energyMax,const_1609,const_1606);
         ...
         this.updateWindow();
         this.var_565 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_220 && this.var_220.isVisible() && param1.isOwnPet)
         {
            this.var_220.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_220.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1607,const_1602,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1604);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1601);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_696,_loc7_.width - 2,_loc7_.height - 2 - const_696);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_696);
      ...
      private function openTrainView() : void
      {
         if(this.var_220 == null)
         {
            this.var_220 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_565) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_220.showWindow(true);
            this.var_220.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc3_:IWindow = this.var_49.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         _loc6_ = this.var_49.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_49.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_49.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_49.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_220 && this.var_220.getPetId() == this.var_565)
               {
                  this.var_220.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1833,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_439,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1098 + const_1097;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1097;
            }
         }
         this.var_107.height = _loc4_ + const_1098;
         this.updateWindow();
      }
   }
}
