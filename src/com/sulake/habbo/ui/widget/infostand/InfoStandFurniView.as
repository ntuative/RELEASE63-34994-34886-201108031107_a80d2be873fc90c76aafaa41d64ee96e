package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected var var_49:IBorderWindow;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_266 = this.var_49.findChildByTag("catalog");
      ...
      {
         if(this.var_55 == null || this.var_49 == null || this._buttons == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_49.width,this._buttons.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_49.width < this._buttons.width)
         {
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1324 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_493 && param1.isRoomOwner)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     ...
                     _loc6_.addEventListener(WindowKeyboardEvent.const_199,this.adElementKeyEventProc);
                  }
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1362.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
      ...
      private function getVisibleAdFurnitureExtraParams() : String
      {
         ...
         {
            _loc2_ = [];
            this.var_49.groupChildrenWithTag("branding_element",_loc2_,true);
            if(_loc2_.length > 0)
            {
      ...
      private function showAdFurnitureDetails(param1:Boolean) : void
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = null;
         if(this._widget == null || this.var_49 == null)
         {
            return;
         }
         var _loc2_:IWindow = this.var_49.findChildByName("furni_details_spacer");
         if(_loc2_ != null)
         {
            _loc2_.visible = param1;
         }
         var _loc3_:* = [];
         this.var_49.groupChildrenWithTag("branding_element",_loc3_,true);
         if(_loc3_.length > 0)
         {
            for each(_loc8_ in _loc3_)
            {
               this.var_49.removeChild(_loc8_);
               _loc8_.dispose();
            }
         }
         var _loc4_:Boolean = false;
         var _loc5_:IWindow = this.var_49.findChildByName("furni_details_text") as ITextWindow;
         if(_loc5_ != null)
         {
