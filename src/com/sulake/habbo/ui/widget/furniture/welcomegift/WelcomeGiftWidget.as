package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_684:String = "welcome_gift_email_unverified";
      
      private const const_1066:String = "welcome_gift_email_verified";
      
      private const const_1506:String = "welcome_gift_email_change";
      
      private const const_2384:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1226)
         {
            this.setViewState(this.const_1066);
         }
         else
         {
            this.setViewState(this.const_684);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_684:
               ...
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_29,this.var_982);
               break;
            case this.const_1066:
      ...
      {
         this.setViewState(this.const_1506);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_892,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1226 ? this.const_1066 : this.const_684);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1519 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1519));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_656,this.method_1);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_844,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_656,this.method_1);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_844,this.emailChangeHandler);
      }
      
      private function method_1(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_656:
               this.var_1520 = param1.email;
               this.var_1226 = param1.isVerified;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1520 = this.var_1519;
            this.setViewState(this.const_684);
         }
         else
         {
            if(param1.result == this.const_2384)
            {
               this.var_982 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1519);
