package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2097:int = 2;
      
      private const const_2095:int = 3;
      
      private const const_2094:int = 4;
      
      private const const_2371:int = 0;
      
      private const const_2376:int = 1;
      ...
      private const const_2369:int = 5;
      
      private const const_2096:String = "deco_img";
      
      private const const_2091:String = "dialog_bg";
      
      private const const_2372:String = "%campaign%_dialog_bg.png";
      
      private const const_386:String = "%campaign%_gift_package.png";
      
      private const const_2377:String = "%campaign%_gift_content.png";
      
      private const const_2374:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1450 = this.var_155.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1450 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1451.length)
         {
            _loc2_ = this.var_1451.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_155 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_551,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_866,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_924,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_551,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_551:
               _loc2_ = this.const_2092;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_924:
               ...
               this._shareId = null;
               this.var_1453 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_866:
               _loc2_ = this.const_2093;
               this.var_235 = param1.objectId;
         ...
         if(this._window && (this.var_1452 != _loc2_ || _loc3_ != this.var_191))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_191 = _loc3_;
         this.var_1452 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1452)
            {
               ...
               case this.const_2093:
                  ...
                  else if(this.var_433 == this.const_2376)
                  {
                     ...
                     _loc2_ = this.const_2377;
                  }
                  else if(this.var_433 == this.const_2373)
                  {
                  ...
                  else if(this.var_433 == this.const_2375)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_191,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_433 == this.const_2369)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2372.replace("%campaign%",this.var_191);
            this.setDecoImage(_loc5_,this.const_2091);
            _loc2_ = _loc2_.replace("%campaign%",this.var_191);
            this.setDecoImage(_loc2_,this.const_2096);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_793);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         var _loc4_:String = this.var_155.getKey("viral.furni.post_type","feed");
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_12)
         {
            if(this.var_1453 != 0)
            {
               this.var_12.toggleInventoryPage(this.var_1453 == 1 ? "null" : InventoryCategory.const_125);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "", param4:int = 0) : void
      {
         ...
         if(messageListener != null)
         {
            _loc5_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_968,"ViralGift",param1,param2,param3,param4);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1451.push(new ImageDownloader(this,_assets,this.var_191,this.var_1450,param1,param2));
            return;
         }
         var _loc5_:BitmapData = (_loc4_.content as BitmapData).clone();
         switch(param2)
         {
            case this.const_2091:
