package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_579:IItemGridWindow;
      
      private var _view:DimmerView;
      
      private var var_2056:XML;
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_579.numGridItems)
         {
            return;
         }
         this.select(this.var_579.getGridItemAt(param1) as IWindowContainer);
      }
      
      private function populate(param1:IHabboWindowManager) : void
      {
         if(this._view == null || this.var_579 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_2056) as IWindowContainer;
            ...
            this.var_579.addGridItem(_loc3_);
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1318.width,this.var_1318.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_1062.width,this.var_1062.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_1062,this.var_1062.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = this.var_579.getGridItemIndex(param1.target as IWindow);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_2056 = XML(_loc2_.content);
         ...
         this.var_1318 = BitmapData(_loc3_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_selected"));
         this.var_1062 = BitmapData(_loc3_.content);
      }
