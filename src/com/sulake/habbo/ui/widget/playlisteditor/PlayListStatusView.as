package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_941:String = "PLSV_ADD_SONGS";
      
      public static const const_1220:String = "PLSV_START_PLAYBACK";
      
      public static const const_496:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_496)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_483[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_483[const_941];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_483.add(const_496,_loc1_);
