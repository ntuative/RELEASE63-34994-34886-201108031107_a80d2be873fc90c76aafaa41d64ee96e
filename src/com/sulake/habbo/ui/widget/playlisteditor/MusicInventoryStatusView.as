package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_825:String = "MISV_BUY_MORE";
      
      public static const const_986:String = "MISV_PREVIEW_PLAYING";
      ...
      private var var_2121:ITextWindow;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_483.getValues())
         {
            _loc1_.destroy();
         }
         this.var_483 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_483[param1] as IWindowContainer,0);
         this.var_53 = param1;
      }
      
      public function set songName(param1:String) : void
      {
         if(this.var_2122 == null)
         {
            return;
         }
         this.var_2122.text = param1;
      }
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_2121.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_986,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_825,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_483.add(const_986,_loc1_);
            this.var_2122 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_2121 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
         ...
         if(_loc1_ != null)
         {
            this.var_483.add(const_825,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_540));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_483[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
