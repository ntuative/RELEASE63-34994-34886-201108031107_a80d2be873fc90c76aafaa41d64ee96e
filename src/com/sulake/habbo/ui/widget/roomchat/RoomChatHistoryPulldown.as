package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_1053:int = 3;
      ...
      private static const const_1072:int = 150;
      
      private static const const_1071:int = 250;
      ...
      private var var_1899:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_43 = param3;
         this.var_2537 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1900 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2540 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1899 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1898 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2541 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2542 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_84 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_361,HabboWindowStyle.const_30,HabboWindowParam.const_64,new Rectangle(0,0,param3.width,param3.height - const_88),null,0,0) as IBitmapWrapperWindow;
         this.var_43.addChild(this.var_84);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_71,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_43.height - const_88,param3.width,const_88),null,0) as IWindowContainer;
         this.var_43.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_333,HabboWindowStyle.const_46,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_88),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_666:
               this.var_84.blend += param1 / const_1071;
               this._window.blend += param1 / const_1071;
               ...
               break;
            case const_1053:
               this.var_84.blend -= param1 / const_1072;
               this._window.blend -= param1 / const_1072;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_43.height - const_88;
            this._window.width = this.var_43.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_43.height - const_88;
            this._region.width = this.var_43.width - this.var_2538;
         }
         if(this.var_84 != null)
         {
            this.var_84.rectangle = this.var_43.rectangle;
            this.var_84.height -= const_88;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2539 == this._window.width)
         {
            return;
         }
         this.var_2539 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2540;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1899;
            barX.disposesBitmap = false;
            this.var_2538 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2537,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1900,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1900,destGripRBitmap);
         ...
         this.var_84.bitmap = this.var_2542;
