package com.sulake.habbo.ui.widget.events
{
   ...
   public class RoomWidgetChatUpdateEvent extends RoomWidgetUpdateEvent
   {
      ...
      private var var_2927:Number;
      
      private var var_2924:Number;
      
      private var var_2925:BitmapData;
      
      private var var_2928:uint;
      ...
      public function RoomWidgetChatUpdateEvent(param1:String, param2:int, param3:String, param4:String, param5:int, param6:Number, param7:Number, param8:BitmapData, param9:uint, param10:int, param11:int, param12:int = 0, param13:Array = null, param14:Boolean = false, param15:Boolean = false)
      {
         ...
         this.var_1667 = param13;
         this.var_2927 = param6;
         this.var_2924 = param7;
         this.var_2925 = param8;
         this.var_2928 = param9;
