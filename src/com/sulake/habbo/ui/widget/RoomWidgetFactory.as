package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_3116:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3116 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_425:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_76,this.var_155,this.var_2955++,this);
               break;
            case RoomWidgetEnum.const_373:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_76,this.var_155,this);
               break;
            case RoomWidgetEnum.const_535:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_76,this.var_155,this._catalog);
               break;
            case RoomWidgetEnum.const_628:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_76,events,this.var_155);
               break;
            ...
            case RoomWidgetEnum.const_507:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_76,this.var_155,this.var_12);
               break;
            ...
            case RoomWidgetEnum.const_674:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_76,this.var_155);
               break;
            case RoomWidgetEnum.const_532:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_76,this.var_155);
               break;
            case RoomWidgetEnum.const_123:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_76,this.var_155);
               break;
            ...
            case RoomWidgetEnum.const_131:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_155,this.var_76,this);
               break;
            ...
            case RoomWidgetEnum.const_579:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_76,this.var_155,this._catalog);
               break;
