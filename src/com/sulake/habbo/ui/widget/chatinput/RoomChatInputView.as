package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1456:int = 250;
      
      private static const const_1455:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1454:String = "${widgets.chatinput.say}";
      ...
      private var var_1762:IWindow;
      
      private var _button:IWindow;
      
      private var var_1763:IWindow;
      
      private var var_1465:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1178 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2350 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2351 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_367 = new Timer(1000,1);
         this.var_367.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_367.reset();
            this.var_367.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_367 = null;
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1762 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1763 = this._window.findChildByName("send_button_text");
         this.var_1465 = this._window.findChildByName("block_text");
         this.var_1763.caption = const_1454;
         ...
         this.var_26.addEventListener(WindowKeyboardEvent.const_199,this.windowKeyEventProcessor);
         this.var_26.addEventListener(WindowKeyboardEvent.const_362,this.keyUpHandler);
         this.var_26.addEventListener(WindowEvent.const_115,this.onInputChanged);
         ...
         this._window.addEventListener(WindowEvent.const_599,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1762.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1456 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1455);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_26 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1178 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_26.text = "";
                  this.var_632 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_632.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_631);
