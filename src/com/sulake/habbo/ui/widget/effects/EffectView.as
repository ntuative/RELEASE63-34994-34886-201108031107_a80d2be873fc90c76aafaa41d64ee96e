package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2404:int = 1000;
      
      private var _widget:EffectsWidget;
      
      private var _window:IWindowContainer;
      
      private var var_116:IWidgetAvatarEffect;
      
      private var var_745:IWindow;
      
      private var var_324:Number;
      
      private var var_417:ITextWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_116 = param2;
         this._widget = param1;
         this.var_215 = new Timer(this.const_2404);
         this.var_215.addEventListener(TimerEvent.TIMER,this.onUpdate);
         this.update();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_215.stop();
            this.var_215.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_215 = null;
         }
         this._widget = null;
         this.var_116 = null;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_116.isActive)
         {
            _loc2_ = this.var_116.secondsLeft / Number(this.var_116.duration);
            this.var_745.width = _loc2_ * this.var_324;
         }
         else
         {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_417 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_417 == null)
            {
               return;
            }
         ...
         if(!this.var_116.isActive)
         {
            this.var_417.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         if(this.var_116.secondsLeft > 86400)
         {
            this.var_417.caption = "${widgets.memenu.effects.active.daysleft}";
            _loc1_ = this.var_417.text;
            _loc2_ = Math.floor(this.var_116.secondsLeft / 86400);
            _loc1_ = _loc1_.replace("%days_left%",_loc2_);
         }
         else
         {
            this.var_417.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_417.text;
            _loc3_ = this.var_116.secondsLeft;
      ...
      public function update() : void
      {
         ...
         this.var_417 = null;
         var _loc2_:String = "";
         if(this.var_116.isInUse)
         {
            _loc2_ = "memenu_effect_selected";
         }
         else if(this.var_116.isActive)
         {
         ...
         if(this.var_745 != null)
         {
            this.var_324 = this.var_745.width;
            this.var_215.start();
            this.onUpdate();
         }
         if(this.var_116.icon)
         {
            this.setElementBitmap("effect_icon",this.var_116.icon);
         }
      ...
      private function onMouseEvent(param1:WindowMouseEvent) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               this._widget.selectEffect(this.var_116.type,this.var_116.isInUse);
         }
      }
