package com.sulake.habbo.ui.handler
{
   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_131;
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         {
            this._container.toolbar.events.removeEventListener(HabboToolbarEvent.const_48,this.onToolbarClicked);
         }
         if(this._container && this._container.sessionDataManager && this._container.sessionDataManager.events)
         {
            this._container.sessionDataManager.events.removeEventListener(UserNameUpdateEvent.const_896,this.onUserNameUpdate);
         }
         this._container = param1;
         if(this._container && this._container.toolbar && this._container.toolbar.events)
         {
            this._container.toolbar.events.addEventListener(HabboToolbarEvent.const_48,this.onToolbarClicked);
         }
         if(this._container && this._container.sessionDataManager && this._container.sessionDataManager.events)
         {
            this._container.sessionDataManager.events.addEventListener(UserNameUpdateEvent.const_896,this.onUserNameUpdate);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_843);
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(RoomSessionDanceEvent.const_156);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_843:
               this.dispatchOwnAvatarInfo();
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserDataUpdateEvent.const_124:
               ...
               break;
            case RoomSessionDanceEvent.const_156:
