package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      private var var_2071:BitmapData;
      ...
      {
         return RoomWidgetEnum.const_628;
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this.var_12.events.removeEventListener(HabboInventoryEffectsEvent.const_286,this.onAvatarEffectsChanged);
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_330,this.onHabboClubSubscriptionChanged);
            }
         ...
         if(this.var_12 != null)
         {
            this.var_12.events.addEventListener(HabboInventoryEffectsEvent.const_286,this.onAvatarEffectsChanged);
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_330,this.onHabboClubSubscriptionChanged);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1617)
            {
               ...
               this.var_1617 = _loc3_;
               this.var_2071 = _loc1_;
               this.var_2070 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_2071;
               _loc2_ = this.var_2070;
            }
         }
         if(this._toolbar != null)
         {
            ...
            {
               if(_loc1_.height > const_479)
               {
                  _loc7_ = new BitmapData(_loc1_.width,const_479,true,0);
                  _loc8_ = _loc7_.rect.clone();
                  if(_loc2_.height > const_479 - const_1120)
                  {
                     _loc8_.offset(0,_loc2_.height - const_479 + const_1120);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_749);
         _loc1_.push(RoomWidgetDanceMessage.const_870);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_832);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1393);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1341);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1218);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_977);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_814);
         _loc1_.push(RoomWidgetStopEffectMessage.const_913);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1982);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1245);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_568);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1962);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1208);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_830);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_840);
         _loc1_.push(RoomWidgetMeMenuMessage.const_791);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_821);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1797);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1024);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_745);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1293);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_395);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_840:
               ...
               break;
            case RoomWidgetWaveMessage.const_749:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_870:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_832:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1393:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1341:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_814:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1239)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_977:
               ...
               if(this.var_12 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1830:
                        this._catalog.openCatalogPage(CatalogPageName.const_1267,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1382:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_282);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1963:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_77);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1882:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_913:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1245:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_830:
               ...
               break;
            case RoomWidgetMeMenuMessage.const_791:
               ...
               break;
            case RoomWidgetAvatarEditorMessage.const_568:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_821:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_434,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_1024:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_434,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_745:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_434,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1293:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_573));
               }
               break;
            default:
