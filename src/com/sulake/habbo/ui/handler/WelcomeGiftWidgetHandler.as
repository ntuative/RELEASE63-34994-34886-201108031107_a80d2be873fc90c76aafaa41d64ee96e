package com.sulake.habbo.ui.handler
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_653;
      }
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_869 = [];
         this.var_869.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_869.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_869)
         {
            return;
         }
         for each(_loc1_ in this.var_869)
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetFurniActionMessage.const_892);
         _loc1_.push(RoomWidgetChangeEmailMessage.const_838);
         return _loc1_;
      }
