package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_805);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_900);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_785);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_805:
            ...
            case RoomWidgetFriendRequestMessage.const_900:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_785:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_87);
         _loc1_.push(FriendRequestEvent.const_58);
         _loc1_.push(FriendRequestEvent.const_223);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_87:
               ...
               break;
            case FriendRequestEvent.const_58:
            case FriendRequestEvent.const_223:
