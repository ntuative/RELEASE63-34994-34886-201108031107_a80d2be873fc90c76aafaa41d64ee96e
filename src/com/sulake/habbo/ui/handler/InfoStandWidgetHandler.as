package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_245.events.addEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_197,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_179,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_193,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_197,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_179,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_193,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_683.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_683.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_245 != null)
         {
            this.var_245.events.removeEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_559);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_853);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_518);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_541);
         _loc1_.push(RoomWidgetUserActionMessage.const_553);
         _loc1_.push(RoomWidgetUserActionMessage.const_750);
         _loc1_.push(RoomWidgetFurniActionMessage.const_298);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1017);
         _loc1_.push(RoomWidgetFurniActionMessage.const_873);
         _loc1_.push(RoomWidgetFurniActionMessage.const_897);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1198);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_753);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_846);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_854);
         _loc1_.push(RoomWidgetUserActionMessage.const_647);
         _loc1_.push(RoomWidgetUserActionMessage.const_652);
         _loc1_.push(RoomWidgetUserActionMessage.const_665);
         _loc1_.push(RoomWidgetUserActionMessage.const_1956);
         _loc1_.push(RoomWidgetPetCommandMessage.const_523);
         _loc1_.push(RoomWidgetPetCommandMessage.const_797);
         _loc1_.push(RoomWidgetUserActionMessage.const_613);
         _loc1_.push(RoomWidgetUserActionMessage.const_276);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_909);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_647)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_276 || param1.type == RoomWidgetUserActionMessage.const_613 || param1.type == RoomWidgetUserActionMessage.const_665)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_559:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_853:
            ...
            case RoomWidgetUserActionMessage.const_594:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1405,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_542:
               ...
               break;
            case RoomWidgetUserActionMessage.const_518:
            ...
            case RoomWidgetUserActionMessage.const_668:
               ...
               break;
            case RoomWidgetUserActionMessage.const_541:
            ...
            case RoomWidgetUserActionMessage.const_553:
               ...
               break;
            case RoomWidgetUserActionMessage.const_750:
            ...
            case RoomWidgetFurniActionMessage.const_1198:
               ...
               break;
            case RoomWidgetUserActionMessage.const_276:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_753:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_846:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_854:
            ...
            case RoomWidgetUserActionMessage.const_647:
               ...
               break;
            case RoomWidgetUserActionMessage.const_652:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_313);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_358);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_451) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_451);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_829) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1324;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_313);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1315);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1406);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_493)
                  {
                     _loc30_ = this.var_245.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_436) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_436.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_245.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_234)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc12_.webID);
                  return null;
               }
               if(_loc12_.type == RoomObjectTypeEnum.const_127)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_492)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_377);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_116)
               {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_157)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_772);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_774;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_965;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1841);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_151];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_151:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_683.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_683.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_772);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_245 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_245.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_455,_loc2_,_loc3_,_loc4_));
         }
      }
