package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_832:BitmapData;
      ...
      private var var_1322:Number = 1.0;
      
      private var var_710:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1322,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1070);
         }
      ...
      {
         return int(this.var_1998 * (Number(param1 - this._minValue) / (this.var_1322 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1998 * (this.var_1322 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1069)
         {
            if(param1.type == WindowMouseEvent.const_55 || param1.type == WindowMouseEvent.const_277)
            {
               this.var_1069 = false;
            }
         }
         if(!this.var_1069 || param1.type != WindowEvent.const_447)
         {
            return;
         }
         if(this.var_710 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_710) * this.var_710;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_710 != 0)
            {
               _loc3_ = this.var_1070 + this.var_710;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_832 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_832.width,this.var_832.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_832,this.var_832.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_831 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_831.width,this.var_831.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_831,this.var_831.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1998 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_832 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_831 = BitmapData(_loc2_.content);
      }
   }
}
