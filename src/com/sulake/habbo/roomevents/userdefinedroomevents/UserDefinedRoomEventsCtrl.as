package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_358:int = 3;
      
      private static var var_1561:int = 2;
      ...
      private var var_1971:TriggerConfs;
      
      private var var_1970:ActionTypes;
      
      private var var_1969:ConditionTypes;
      
      private var var_279:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_820:RoomObjectHightLighter;
      
      private var var_200:UserDefinedRoomEventsHelp;
      
      private var var_1269:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1971 = new TriggerConfs();
         this.var_1970 = new ActionTypes();
         this.var_1969 = new ConditionTypes();
         this.var_279 = new Dictionary();
         super();
         this.var_92 = param1;
         this.var_820 = new RoomObjectHightLighter(param1);
         this.var_200 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_279[param1])
         {
            ...
            this.var_820.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_279[param1] = param2;
            this.var_820.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1269 = new SliderWindowController(this.var_92,IWindowContainer(this.find(this.var_56,"delay_slider_container")),this.var_92.assets,0,20,1);
         this.var_1269.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1269.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_820.hideAll(this.var_279);
         }
      }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_37.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_358)
            {
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_92.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_37.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_37 as TriggerDefinition != null)
         {
            this.var_92.send(new UpdateTriggerMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_37 as ActionDefinition != null)
         {
            this.var_92.send(new UpdateActionMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_37 as ConditionDefinition != null)
         {
            this.var_92.send(new UpdateConditionMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1269.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_200.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1561) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1561 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_92.send(new ApplySnapshotMessageComposer(this.var_37.id));
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_358)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1971);
         this.refreshConfigureElement(this.var_1970);
         this.refreshConfigureElement(this.var_1969);
