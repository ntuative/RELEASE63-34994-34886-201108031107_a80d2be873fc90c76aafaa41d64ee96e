package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1352:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_2108 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1352 = this.var_2108.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1352)
         {
            this.var_1352.procedure = this.onButtonClick;
         }
         this.var_1351 = this.var_2108.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1351)
         {
            this.var_1351.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_296 >= this.var_76.length - 1)
         {
            this.var_1351.disable();
         }
         else
         {
            this.var_1351.enable();
         }
         if(this.var_296 <= 0)
         {
            this.var_1352.disable();
         }
         else
         {
            this.var_1352.enable();
         }
      }
      ...
      {
         ++this.var_296;
         this.var_296 = Math.min(this.var_296,this.var_76.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_296;
         this.var_296 = Math.max(this.var_296,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_76[this.var_296][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_76[this.var_296][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_76[this.var_296][1]).value;
