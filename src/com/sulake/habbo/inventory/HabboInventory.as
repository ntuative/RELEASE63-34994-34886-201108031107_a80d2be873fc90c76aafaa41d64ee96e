   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionEvent.const_81,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_648,this.roomSessionEventHandler);
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_63.getValue(InventorySubCategory.const_364));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_63.getValue(InventoryCategory.const_153));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_63.getValue(InventoryCategory.const_282));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_63.getValue(InventorySubCategory.const_1300));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_63.getValue(InventoryCategory.const_125));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_63.getValue(InventoryCategory.const_430) as MarketplaceModel;
      }
      ...
      {
         return this.var_112.clubDays;
      }
      
      public function get clubPeriods() : int
      {
         return this.var_112.clubPeriods;
      }
      
      public function get clubPastPeriods() : int
      {
         return this.var_112.clubPastPeriods;
      }
      
      public function get clubHasEverBeenMember() : Boolean
      {
         return this.var_112.clubHasEverBeenMember;
      }
      
      public function get clubIsExpiring() : Boolean
      {
         return this.var_112.clubIsExpiring;
      }
      ...
      public function get clubLevel() : int
      {
         ...
         {
            return HabboClubLevelEnum.const_36;
         }
      ...
      {
         this.var_112.clubPeriods = param1;
         this.var_112.clubDays = param2;
         this.var_112.clubHasEverBeenMember = param3;
         this.var_112.isVIP = param4;
         this.var_112.clubIsExpiring = param5;
      ...
      {
         this.var_387 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_81,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_648,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_81:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_648:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_387 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_63.add(InventoryCategory.const_430,_loc1_);
         ...
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_387);
         this.var_63.add(InventoryCategory.const_282,_loc3_);
         ...
         this.var_63.add(InventoryCategory.const_153,_loc4_);
         ...
         this.var_63.add(InventorySubCategory.const_364,_loc5_);
         ...
         this.var_63.add(InventorySubCategory.const_1300,_loc6_);
         ...
         this.var_63.add(InventoryCategory.const_125,_loc7_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_1040.indexOf(param1);
            if(_loc3_ >= 0)
            {
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_286));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2750)
         {
            this.var_2750 = _loc1_;
