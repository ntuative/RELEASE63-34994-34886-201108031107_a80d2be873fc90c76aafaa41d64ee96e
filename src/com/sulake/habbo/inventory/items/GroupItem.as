package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_947:int = 0;
      
      protected var var_760:BitmapData;
      
      protected var var_2735:int;
      
      protected var var_1721:Boolean;
      
      protected var var_2282:Boolean;
      
      protected var var_3074:BitmapData;
      
      private var var_1530:Boolean;
      
      private const const_2106:Number = 1;
      
      private const const_2105:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2284 == FurniModelCategory.const_38)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1866));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2283);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_1013)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2105;
               _loc1_.blend = this.const_2105;
            }
            else
            {
               this._window.blend = this.const_2106;
               _loc1_.blend = this.const_2106;
            }
         }
         this.var_1664.color = !!this.var_1530 ? uint(const_1518) : uint(const_1519);
         this.var_2543.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2282 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3074;
               _loc5_.visible = true;
            }
            else
            {
