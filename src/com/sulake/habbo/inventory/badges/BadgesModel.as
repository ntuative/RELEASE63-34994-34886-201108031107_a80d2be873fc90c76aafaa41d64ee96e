package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public static const const_667:int = 0;
      ...
      private const const_2381:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_777 = new Array();
         this._assets = param4;
         this._communication = param3;
         this.var_387 = param5;
         this.var_387.events.addEventListener(BadgeImageReadyEvent.const_179,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_387.events.removeEventListener(BadgeImageReadyEvent.const_179,this.onBadgeImageReady);
            this.var_387 = null;
         }
      }
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(this.var_777[_loc2_] == param1)
            {
               this.var_777.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1191.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_640.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_387.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_239.unshift(_loc11_);
            }
            else
            {
               this.var_239.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_359);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_239.length)
         {
            _loc3_ = this.var_239[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_667);
         ...
         var _loc3_:Array = this.getBadges(const_359);
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case const_667:
               _loc2_ = new Array();
               for each(_loc3_ in this.var_239)
               {
                  if(!_loc3_.isInUse)
                  {
                     _loc2_.push(_loc3_);
      ...
      {
         return this.getItemInIndex(param1,const_359);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_667);
      }
      ...
      {
         if(param1 == InventoryCategory.const_282 && this.var_27.isVisible)
         {
      ...
      public function resetUnseenItems() : void
      {
         ...
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1262));
            this.var_640 = [];
            for each(_loc2_ in this.var_239)
            {
