package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1700:int = 100;
      
      private static const const_1701:int = 1000;
      ...
      private var var_730:Timer;
      
      private var var_2333:Boolean;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1661:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_495 = [];
         this.var_494 = [];
         this.var_730 = new Timer(const_1700,1);
         this.var_730.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2981 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_730.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_730.stop();
               this.var_730 = null;
            }
            if(this.var_231 != null)
            {
               this.var_231.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_231.stop();
               this.var_231 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_38)
            {
               if(this.var_1661 == null)
               {
                  this.var_1661 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1661;
            }
            else
            {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_356)
         {
         ...
         else if(param3 == FurniCategory.const_347)
         {
         ...
         if(this.var_891 == null)
         {
            this.var_891 = this._windowManager.buildFromXML(this.var_2981) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_891.findChildByName("outline") as IBitmapWrapperWindow;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_231 = new Timer(param1,1);
            this.var_231.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_231.start();
         }
         else
         {
         ...
         if(param1 == InventoryCategory.const_77 && this.var_27.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_269:
                  this.var_27.toggleInventoryPage(InventoryCategory.const_125);
            }
         }
      }
      ...
      {
         this.var_2982 = getTimer();
         this.switchCategory(const_269);
      }
      ...
      {
         this.var_27.checkCategoryInitilization(InventoryCategory.const_430);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_731.add(const_38,new Array());
         this.var_731.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_38;
            _loc5_ = this.var_495.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_45;
            _loc5_ = this.var_494.indexOf(param1.ref) > -1;
         }
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_208)
                  {
                     _loc7_ = _loc9_;
                  }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_269)
            {
      ...
      {
         return getTimer() < this.var_2982 + const_1701;
      }
      ...
      {
         return this.var_27.getSubCategoryViewId() == InventorySubCategory.const_364;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_347 || _loc3_.category == FurniCategory.const_356 || _loc3_.category == FurniCategory.const_326)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_731.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_364:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_731.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_1013)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_495.indexOf(_loc2_) == -1)
            {
               this.var_495.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_494.indexOf(_loc2_) == -1)
            {
               this.var_494.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_429:
               return this.var_495.length;
            case UnseenItemCategoryEnum.const_400:
               return this.var_494.length;
            default:
               return this.var_495.length + this.var_494.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_45:
               if(this.var_494 && this.var_494.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_400));
                  this.var_494 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
               break;
            case const_38:
               if(this.var_495 && this.var_495.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_429));
                  this.var_495 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
