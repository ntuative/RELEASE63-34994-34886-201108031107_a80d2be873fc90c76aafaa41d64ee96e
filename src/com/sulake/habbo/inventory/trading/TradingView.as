package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1061:uint = 2577770;
      
      public static const const_1264:int = 0;
      
      public static const const_1301:int = 1;
      
      public static const const_1195:int = 2;
      ...
      private var var_650:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_650 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_215)
            {
               this.var_215.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_215.stop();
               this.var_215 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1833 = this.createMinimizedWindow();
         }
         if(!this.var_1169)
         {
            return this.var_79;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_79)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.ownUserAccepts ? uint(const_1062) : uint(const_1061);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.otherUserAccepts ? uint(const_1062) : uint(const_1061);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_215 = new Timer(1000,3);
            this.var_215.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_215.reset();
         this.var_215.repeatCount = 3;
         this.var_215.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_215.currentCount));
         if(this.var_215.currentCount == 3)
         {
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1822)
            {
            ...
            this.var_650.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_670);
            this.var_650.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_650.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_195.push(param4);
            this.var_195.push(param1);
            this.var_195.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_195.length > 0)
         {
            _loc2_ = this.var_195.pop();
            _loc3_ = this.var_195.pop();
            _loc4_ = uint(this.var_195.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_19.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_19.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_650.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_670);
               }
            }
            else
            {
               this.var_195.push(_loc4_);
               this.var_195.push(_loc3_);
