package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1598:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_695 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_695.width;
         this.var_105 = this.var_695.height;
         this.var_1311 = param5;
         this.var_1049 = param6;
         this.var_252 = Math.floor(this.var_1311 / this._thumbWidth);
         this.var_29 = new BitmapData(this.var_1311,this.var_1049);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_696 = this.resolveRowCountFromList();
         if(this.var_696 == 0)
         {
            this.var_29 = new BitmapData(this.var_1311,this.var_1049);
            return;
         }
         this.var_29 = new BitmapData(Math.max(this.var_252 * this._thumbWidth,this.var_1311),Math.max(this.var_696 * this.var_105,this.var_1049),true,16777215);
         this.var_29.fillRect(this.var_29.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_696)
         {
            _loc4_ = 0;
            while(_loc4_ < this.var_252)
            {
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_252 && this.var_29.height < _loc3_.y * this.var_105)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_252 - 1),this.var_105);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_252 - 1),0,this._thumbWidth,this.var_29.height);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(0,this.var_105),null,null,true);
         _loc4_ = new Rectangle(0,this.var_105,this._thumbWidth * (this.var_252 - 1),this.var_29.height - this.var_105);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1598.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_252));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_252 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_252);
         var _loc3_:int = param1 % this.var_252;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc11_:* = null;
         var _loc12_:* = null;
         if(param1.x >= this.var_252)
         {
            return;
         }
         if(param1.y >= this.var_696)
         {
            return;
         }
         var _loc4_:int = this.var_252 - param1.x - 1;
         ...
         if(this.var_29.height < this.var_1049)
         {
            _loc12_ = new BitmapData(this.var_29.width,this.var_1049);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_695.width,this.var_695.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_695.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_695,this.var_695.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
