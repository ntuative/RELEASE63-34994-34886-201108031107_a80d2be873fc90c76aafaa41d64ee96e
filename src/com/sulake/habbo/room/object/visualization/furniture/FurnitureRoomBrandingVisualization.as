package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1719:String = "branded_image";
      
      private static const const_1721:int = 0;
      
      private static const const_1720:int = 1;
      
      private static const const_1722:int = 2;
      
      private static const const_1718:int = 3;
       
      
      protected var _imageUrl:String;
      
      protected var var_1441:Boolean = false;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1726 = _loc4_.getNumber(RoomObjectVariableEnum.const_502);
                  this.var_1725 = _loc4_.getNumber(RoomObjectVariableEnum.const_495);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_673);
               }
            }
         }
         if(!this.var_1441)
         {
            this.var_1441 = this.checkIfImageReady();
            if(this.var_1441)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
      ...
      protected function checkIfImageChanged() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_343);
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_646);
                     if(_loc4_ == 1)
                     {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1719)
         {
