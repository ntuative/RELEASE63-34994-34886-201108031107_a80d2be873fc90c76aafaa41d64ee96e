package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1497:String = "shore";
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1208)
            {
      ...
      {
         if(this.var_2450 == param1 && this.var_2451 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1497)
            {
               this.var_1832 = _loc2_;
               this.var_2450 = param1;
               this.var_2451 = direction;
               return this.var_1832;
            }
            _loc2_--;
         }
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_535 + 2;
         var _loc4_:int = this.var_649 + 2;
         var _loc5_:int = 0;
         ...
         this.var_1831 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_444.length)
         {
            if(this.var_444[_loc5_] == true)
            {
               this.var_1831 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_648[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_648[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_535 == 0 || this.var_649 == 0)
         {
            ...
            this.var_535 = _loc2_.getNumber(RoomObjectVariableEnum.const_246);
            this.var_649 = _loc2_.getNumber(RoomObjectVariableEnum.const_375);
         }
         this.var_444 = [];
         this.var_648 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_535 * 2 + this.var_649 * 2)
         {
            this.var_444.push(false);
            this.var_648.push(ShoreMaskCreatorUtility.const_83);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_535 + 2;
         var _loc2_:int = this.var_649 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_81,getSize(param3),this.var_444,this.var_648,assetCollection);
      }
