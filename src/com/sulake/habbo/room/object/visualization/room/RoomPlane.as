package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1147:IPlaneRasterizer = null;
      
      private var var_793:PlaneMaskManager = null;
      
      private var _id:String = null;
      
      private var var_3047:Number = 0;
      
      private var var_3048:Number = 0;
      
      private var var_3044:Number = 0;
      
      private var var_3046:Number = 0;
      
      private var var_210:Map = null;
      
      private var var_506:PlaneBitmapData = null;
      ...
      private var var_934:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_317.assign(param3);
         this.var_318 = new Vector3d();
         this.var_318.assign(param4);
         ...
         this.var_3047 = param9;
         this.var_3048 = param10;
         this.var_3044 = param11;
         this.var_3046 = param12;
         this.var_1148 = param6;
      }
      ...
      {
         return this._isVisible && this.var_934;
      }
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_734);
                  return param1;
               }
            }
         }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1147.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_506;
         if(_loc3_ == null)
         {
         ...
         if(this.var_934 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_423))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_317.length * param1.scale;
            _loc6_ = this.var_318.length * param1.scale;
            ...
            if(this.var_1147 != null)
            {
               _loc3_ = this.var_1147.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_2211,this.var_3047,this.var_3048,this.var_3044,this.var_3046,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1754 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_934)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_170.z - originZ,this.var_126.z - originZ,this.var_96.z - originZ,this.var_127.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2328 = relativeDepth;
            this._isVisible = true;
            this.var_1754 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_3045);
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_1148)
         {
            _loc4_ = null;
            _loc5_ = 0;
            while(_loc5_ < this.var_310.length)
            {
               _loc4_ = this.var_310[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_1148)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_424.length)
            {
               _loc5_ = this.var_424[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_310.length == this.var_1146.length)
         {
            while(_loc1_ < this.var_310.length)
            {
               _loc4_ = this.var_310[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_1146.length)
                  {
                     _loc7_ = this.var_1146[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_424.length > this.var_1708.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1148 || this.var_310.length == 0 && this.var_424.length == 0 && !this.var_423 || this.var_793 == null)
         {
            return;
         }
         ...
         if(this.var_423)
         {
            ...
            while(_loc5_ < this.var_310.length)
            {
               _loc3_ = this.var_310[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_81.width - this.var_81.width * _loc3_.leftSideLoc / this.var_317.length;
                  _loc11_ = this.var_81.height - this.var_81.height * _loc3_.rightSideLoc / this.var_318.length;
                  _loc12_ = _loc3_.type;
                  this.var_793.updateMask(this.var_81,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1146.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_424.length)
            {
               _loc4_ = this.var_424[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_81.width - this.var_81.width * _loc4_.leftSideLoc / this.var_317.length;
                  _loc11_ = this.var_81.height - this.var_81.height * _loc4_.rightSideLoc / this.var_318.length;
                  _loc13_ = this.var_81.width * _loc4_.leftSideLength / this.var_317.length;
                  _loc14_ = this.var_81.height * _loc4_.rightSideLength / this.var_318.length;
                  this.var_81.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1708.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_423 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_264.copyChannel(param1,param1.rect,const_734,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_264.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_264,this.var_264.rect,const_734,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
