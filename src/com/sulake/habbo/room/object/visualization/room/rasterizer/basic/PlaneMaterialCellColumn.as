package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellColumn
   {
      ...
      public function render(param1:int, param2:IVector3d) : BitmapData
      {
         ...
         if(this.var_32 == null)
         {
            this.var_32 = new BitmapData(this.var_223,param1,true,16777215);
         }
      ...
      private function method_6(param1:IVector3d) : void
      {
         var _loc4_:* = null;
         if(this.var_36.length == 0 || this.var_32 == null)
         {
