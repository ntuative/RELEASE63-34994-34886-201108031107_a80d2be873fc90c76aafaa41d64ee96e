package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1837:int = 16777215;
      
      public static const const_1883:int = 13421772;
      
      private static const const_1068:int = 16777215;
      
      private static const const_1067:int = 13421772;
      
      private static const const_1070:int = 10066329;
      
      private static const const_1069:int = 10066329;
      
      public static const const_1942:int = 16777215;
      
      public static const const_1924:int = 13421772;
      
      public static const const_1824:int = 10066329;
      ...
      private var var_543:RoomPlaneBitmapMaskParser = null;
      ...
      private const const_2385:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_543 = new RoomPlaneBitmapMaskParser();
         this.var_329["null"] = false;
         this.var_329["null"] = true;
         this.var_329["null"] = true;
         this.var_329["null"] = true;
      }
      ...
      private function resetRoomPlanes() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_153.length)
            {
               _loc2_ = this.var_153[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_153.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_153[_loc2_] as RoomPlane;
            ...
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.rightSide != null)
            {
               ...
               else if(_loc3_.type == RoomPlane.const_114)
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1042))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1042;
         }
         if(!isNaN(this.var_1526))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1526;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_883);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1429);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_264)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_402)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1942;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1924;
               }
               else
               {
                  _loc13_.color = const_1824;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_2059)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_70,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_402)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2385 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_376.length)
            {
               _loc11_ = this.var_661[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_376[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1888)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2526 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2527 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2528 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1754)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1459 || _loc3_.y != this.var_2326 || _loc3_.z != this.var_2325 || param1.scale != this.var_1889))
            {
               this.var_1459 = _loc3_.x;
               this.var_2326 = _loc3_.y;
               this.var_2325 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1250);
            if(_loc3_ != this.var_1887)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1887 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_775));
            if(_loc4_ != this.var_1236)
            {
               this.var_1236 = _loc4_;
               this.var_2526 = this.var_1236 & 255;
               this.var_2527 = this.var_1236 >> 8 & 255;
               this.var_2528 = this.var_1236 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1339));
            if(_loc5_ != this.var_1888)
            {
               this.var_1888 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            ...
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_214);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_777));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_952));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_795));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1276);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1291);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1042 || _loc3_ != this.var_1526))
            {
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1347);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2525)
            {
               this.var_2525 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_153.length)
         {
            _loc5_ = this.var_153[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_114 && param1 != null)
               {
                  _loc5_.id = param1;
               }
      ...
      {
         if(param1 != this.var_329["null"] || param2 != this.var_329["null"] || param3 != this.var_329["null"])
         {
            this.var_329["null"] = param1;
            this.var_329["null"] = param2;
            this.var_329["null"] = param3;
            this.var_376 = [];
            this.var_661 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_376;
         if(this.var_376.length == 0)
         {
            _loc6_ = this.var_153;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_376.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_114)
                        {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_329[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_376.push(_loc12_);
                        this.var_661.push(_loc9_);
                     }
                  }
               }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_543.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_153.length)
         {
            _loc3_ = this.var_153[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_543.maskCount)
         {
            _loc10_ = this.var_543.getMaskType(_loc8_);
            _loc11_ = this.var_543.getMaskLocation(_loc8_);
            _loc12_ = this.var_543.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_153.length)
               {
                  _loc3_ = this.var_153[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_70 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_272)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_153[_loc18_] as RoomPlane;
