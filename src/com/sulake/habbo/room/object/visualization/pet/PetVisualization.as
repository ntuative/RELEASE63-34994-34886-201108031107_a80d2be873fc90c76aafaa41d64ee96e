package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_742:PetVisualizationData = null;
      ...
      private const const_2380:int = 3;
      ...
      private const const_1460:int = 3;
      ...
      private var var_1775:Number = NaN;
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_527.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_527.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
      ...
      {
         this.var_742 = param1 as PetVisualizationData;
         createSprites(this.const_1460);
         var _loc2_:BitmapData = (this.var_742.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_2169 = param1.getNumber(RoomObjectVariableEnum.const_268) > 0;
            this.var_1470 = param1.getString(RoomObjectVariableEnum.const_145);
            this.var_304 = param1.getString(RoomObjectVariableEnum.const_256);
            this.var_1677 = param1.getString(RoomObjectVariableEnum.const_972);
            this.var_1775 = param1.getNumber(RoomObjectVariableEnum.const_203);
            this.var_1461 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2331 = param1.getNumber(RoomObjectVariableEnum.const_415);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_210);
            if(this.var_754 != _loc3_)
            {
               this.var_754 = _loc3_;
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_515 != param1.getUpdateID() || this.var_1754 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1775;
            if(isNaN(this.var_1775))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc4_ != this.var_2173 || param3)
            {
               this.var_2173 = _loc4_;
               _loc4_ -= 112.5;
               _loc4_ = (_loc4_ + 360) % 360;
               this.var_67.setDirectionAngle(AvatarSetType.const_42,_loc4_);
            }
            if(_loc5_ != this.var_2176 || param3)
            {
               this.var_2176 = _loc5_;
               _loc5_ -= 112.5;
               _loc5_ = (_loc5_ + 360) % 360;
               this.var_67.setDirectionAngle(AvatarSetType.const_56,_loc5_);
            }
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         var _loc3_:IAvatarImage = this.var_527.getValue(_loc2_) as IAvatarImage;
         if(_loc3_ == null)
         {
            _loc3_ = this.var_742.getAvatar(this.var_754,param1,this);
            if(_loc3_ != null)
            {
               this.var_527.add(_loc2_,_loc3_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_743 = null;
         _loc2_ = getSprite(this.const_2102);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc10_ || _loc7_ != var_100 || this.var_67 == null)
         {
            if(_loc7_ != var_100)
            {
               var_100 = _loc7_;
         ...
         if(_loc11_ || _loc12_)
         {
            ...
            _loc14_ = getSprite(this.const_1155);
            if(_loc14_)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1470 != null && this.var_1470 != "")
         {
            param1.appendAction(AvatarAction.const_344,this.var_1470);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1460;
