package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1449:String = "head";
      
      private static const const_680:int = 1;
      
      private static const const_1047:int = 1000;
      
      private static const const_1447:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1447) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_366 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2330)
            {
               this.var_2330 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_146)
         {
            ...
            if(!isNaN(_loc6_))
            {
               _loc10_ = this._animationData.getPostureCount(var_100);
               if(_loc10_ > 0)
               {
                  _loc4_ = this._animationData.getPostureForAnimation(var_100,_loc6_ % _loc10_);
                  _loc5_ = null;
               }
            }
            ...
            if(!isNaN(_loc7_))
            {
               _loc11_ = this._animationData.getGestureCount(var_100);
               if(_loc11_ > 0)
               {
                  _loc5_ = this._animationData.getGestureForAnimation(var_100,_loc7_ % _loc11_);
               }
            }
            this.validateActions(_loc4_,_loc5_);
            this.var_2169 = _loc3_.getNumber(RoomObjectVariableEnum.const_268) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_203);
            if(!isNaN(_loc8_))
            {
               this.var_1757 = _loc8_;
            }
            else
            {
               this.var_1757 = direction;
            }
            this.var_1461 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2331 = _loc3_.getNumber(RoomObjectVariableEnum.const_415);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_940);
            if(_loc9_ != this.var_1758)
            {
               this.var_1758 = _loc9_;
               this.var_2329 = this.var_1758.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_366 != null)
         {
            ...
            if(this.var_1461 > 0)
            {
               _loc2_ = param1 - this.var_1461;
               if(_loc2_ < const_1047)
               {
                  this.var_366.alpha = int(Math.sin(_loc2_ / const_1047 * 0) * 255);
                  this.var_366.setExperience(this.var_2331);
               }
               else
               {
                  this.var_1461 = 0;
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_366.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_366.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         {
            this.var_304 = param1;
            _loc3_ = this._animationData.getAnimationForPosture(var_100,param1);
            this.setAnimationForIndex(const_1448,_loc3_);
         }
         if(param2 != this.var_1470)
         {
            this.var_1470 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_100,param2);
            this.setAnimationForIndex(const_1450,_loc3_);
         }
      }
      ...
      {
         return super.getAdditionalSpriteCount() + const_680;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2329);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_680)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_680))
            {
               if(param2 >= FurnitureVisualizationData.const_575.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_575[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1757);
         }
         return direction;
      }
      ...
      {
         if(this.var_958[param1] == null)
         {
            if(this._animationData.getTag(var_100,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1449)
            {
               this.var_958[param1] = true;
            }
            else
            {
               this.var_958[param1] = false;
            }
         }
         return this.var_958[param1];
      }
   }
}
