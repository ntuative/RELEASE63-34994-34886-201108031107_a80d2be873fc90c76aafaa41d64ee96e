package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1901:int = 255;
      
      private var var_1528:uint = 16777215;
      
      private var var_1904:int = 255;
      
      private var var_1239:uint = 16777215;
      
      private var var_1903:int = 255;
      
      private var var_1240:int = 0;
      
      private var var_1902:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_588,RoomObjectMouseEvent.const_170];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_883,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_775,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_777,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_952,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_795,1);
         }
      }
         ...
         if(this.var_1529)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_883,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1347,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1240)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1901;
            if(_loc2_ - this.var_1240 >= this.var_1902)
            {
               _loc3_ = this.var_1239;
               _loc4_ = this.var_1903;
               this.var_1240 = 0;
            }
            else
            {
               _loc7_ = this.var_1528 >> 16 & 255;
               _loc8_ = this.var_1528 >> 8 & 255;
               _loc9_ = this.var_1528 & 255;
               _loc10_ = this.var_1239 >> 16 & 255;
               _loc11_ = this.var_1239 >> 8 & 255;
               _loc12_ = this.var_1239 & 255;
               _loc13_ = (_loc2_ - this.var_1240) / this.var_1902;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1904 + (this.var_1903 - this.var_1904) * _loc13_;
               this._color = _loc3_;
               this.var_1901 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_775,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_926:
               param2.setString(RoomObjectVariableEnum.const_227,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_905:
               param2.setString(RoomObjectVariableEnum.const_211,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_1034:
               param2.setString(RoomObjectVariableEnum.const_214,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_602:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_272)
               {
                  _loc5_ = "null";
               }
               this.var_543.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_994:
               _loc4_ = this.var_543.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_543.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1250,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1363:
               param2.setNumber(RoomObjectVariableEnum.const_777,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1340:
               param2.setNumber(RoomObjectVariableEnum.const_952,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_795,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_700:
               param2.setNumber(RoomObjectVariableEnum.const_1276,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1270:
               param2.setNumber(RoomObjectVariableEnum.const_1291,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_164:
               this._planeParser.addFloorHole(param1.id,param1.x,param1.y,param1.width,param1.height);
               this.var_1529 = true;
               break;
            case RoomObjectRoomFloorHoleUpdateMessage.const_143:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1339,int(param1.bgOnly));
         this.var_1528 = this._color;
         this.var_1904 = this.var_1901;
         this.var_1239 = _loc3_;
         this.var_1903 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_590,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1778,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1796,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1808,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_590,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_264 || _loc12_ == RoomPlaneData.const_402)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
