package com.sulake.habbo.room.object
{
   ...
   public class RoomObjectVisualizationFactory extends Component implements IRoomObjectVisualizationFactory
   {
      ...
      private var var_1238:IAvatarRenderManager = null;
      ...
      private function avatarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1238 = param2 as IAvatarRenderManager;
      }
      ...
      public function createRoomObjectVisualization(param1:String) : IRoomObjectGraphicVisualization
      {
         ...
         switch(param1)
         {
            ...
            case RoomObjectVisualizationEnum.const_54:
               ...
               break;
            case RoomObjectVisualizationEnum.const_1274:
               _loc2_ = AnimatedPetVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1289:
               _loc2_ = FurnitureVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1196:
               _loc2_ = AnimatedFurnitureVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1377:
               _loc2_ = ResettingAnimatedFurnitureVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1402:
            ...
            case RoomObjectVisualizationEnum.const_1234:
               ...
               break;
            case RoomObjectVisualizationEnum.const_1314:
               _loc2_ = FurniturePartyBeamerVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1978:
               _loc2_ = FurnitureCuboidVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1331:
               _loc2_ = FurnitureGiftWrappedVisualization;
               break;
            case RoomObjectVisualizationEnum.const_384:
               _loc2_ = FurnitureCounterClockVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1361:
            ...
            case RoomObjectVisualizationEnum.const_325:
               ...
               break;
            case RoomObjectVisualizationEnum.const_381:
            ...
            case RoomObjectVisualizationEnum.const_374:
               ...
               break;
            case RoomObjectVisualizationEnum.const_380:
