   ...
   public class RoomObjectFactory extends Component implements IRoomObjectFactory
   {
      ...
      public function addObjectEventListener(param1:Function) : void
      {
         ...
         if(this.var_1006.indexOf(param1) < 0)
         {
            ...
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1260.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         if(this.var_1260.getValue(param1) == null)
         {
            this.var_1260.add(param1,true);
      ...
      public function createRoomObjectLogic(param1:String) : IRoomObjectEventHandler
      {
         ...
         switch(param1)
         {
            case RoomObjectLogicEnum.const_1936:
               ...
               break;
            case RoomObjectLogicEnum.const_1897:
            ...
            case RoomObjectLogicEnum.const_1898:
               ...
               break;
            case RoomObjectLogicEnum.const_2043:
               _loc2_ = FurnitureTrophyLogic;
               break;
            case RoomObjectLogicEnum.const_1899:
            ...
            case RoomObjectLogicEnum.const_357:
               ...
               break;
            case RoomObjectLogicEnum.const_2067:
               _loc2_ = FurnitureWindowLogic;
               break;
            case RoomObjectLogicEnum.const_1861:
               _loc2_ = FurnitureRoomDimmerLogic;
               break;
            case RoomObjectLogicEnum.const_2050:
               _loc2_ = RoomTileCursorLogic;
               break;
            case RoomObjectLogicEnum.const_1804:
               _loc2_ = SelectionArrowLogic;
               break;
            case RoomObjectLogicEnum.const_2023:
            ...
            case RoomObjectLogicEnum.const_1980:
               ...
               break;
            case RoomObjectLogicEnum.const_1995:
         ...
         if(_loc3_ is IRoomObjectEventHandler)
         {
            ...
            if(this.var_1952.getValue(param1) == null)
            {
               this.var_1952.add(param1,true);
