package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_837)
         {
            this.var_837 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_837)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_838)
         {
            this.var_838 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_838)
            {
               return;
            }
