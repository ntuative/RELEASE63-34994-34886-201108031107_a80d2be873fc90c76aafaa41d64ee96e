package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      public function dispose() : void
      {
         if(this.var_200)
         {
            this.var_200.removeUpdateReceiver(this);
            this.var_200.toolbar.events.removeEventListener(HabboToolbarEvent.const_48,this.onToolbarClicked);
            this.var_200 = null;
         }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         ...
         this.var_70 = param1;
         this.var_200.toolbar.events.addEventListener(HabboToolbarEvent.const_48,this.onToolbarClicked);
         if(this._window == null)
         {
            this.initializeWindow();
         }
         var _loc2_:ITextWindow = ITextWindow(this._window.findChildByName("text"));
         _loc2_.caption = this.var_200.localization.getKey(param1.localizationKey);
         _loc2_.height = _loc2_.textHeight + 5;
         this.var_211.y = this.var_200.toolbar.getIconVerticalLocation(param1.targetIconId) - this._window.height / 2;
         this._window.y = this.var_211.y;
      ...
      {
         var _loc1_:XmlAsset = this.var_200.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_200.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
         ...
         _loc4_.content.setParamFlag(WindowParam.const_247,false);
         _loc4_.height -= 20;
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_211);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_211,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_211.x;
            this._window.y = this.var_211.y;
            this.var_200.removeUpdateReceiver(this);
         }
      }
      ...
      {
         this.var_200.removeUpdateReceiver(this);
         this.var_200.registerUpdateReceiver(this,10);
      }
   }
}
