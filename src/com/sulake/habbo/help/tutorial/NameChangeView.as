package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1584:uint = 13232628;
      
      private static var var_2009:uint = 11129827;
      ...
      private var var_2010:IWindowContainer;
      ...
      private var var_1295:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_2010 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_837)
         {
            this.var_837 = this.var_27.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_837)
            {
               return;
            }
            this._window.content.addChild(this.var_837);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_838)
         {
            this.var_838 = this.var_27.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_838)
            {
               return;
            }
         ...
         var _loc1_:ITextWindow = this.var_838.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_564;
         }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_27.localization.registerParameter("help.tutorial.name.available","name",this.var_564);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_939:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1153:
               _loc4_.text = this.var_27.localization.getKey("help.tutorial.name.change_not_allowed");
               break;
            case ChangeUserNameResultMessageEvent.var_1154:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1154 || param1 == ChangeUserNameResultMessageEvent.var_1153)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1295 = new NameSuggestionListRenderer(this.var_27);
         var _loc6_:int = this.var_1295.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1584;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_564 = this.var_27.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_564 != _loc5_)
               {
                  this.var_2008 = _loc5_;
            ...
            case "confirm_name_button":
               this.var_27.changeName(this.var_564);
               break;
