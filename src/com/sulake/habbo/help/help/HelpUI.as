package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2042:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201108031102));
         this.var_135 = new Map();
         this.var_135.add(HabboHelpViewEnum.const_1937,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_135.add(HabboHelpViewEnum.const_225,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_135.add(HabboHelpViewEnum.const_526,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_135.add(HabboHelpViewEnum.const_351,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_135.add(HabboHelpViewEnum.const_250,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_135.add(HabboHelpViewEnum.const_409,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_135.add(HabboHelpViewEnum.const_943,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_135.add(HabboHelpViewEnum.const_311,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_135.add(HabboHelpViewEnum.const_1421,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_135.add(HabboHelpViewEnum.const_1378,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_135.add(HabboHelpViewEnum.const_833,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_578.length == 0 || param1 != this.var_389)
            {
               this.var_578.push(this.var_389);
            }
         }
         this.var_389 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_311:
               this.showUI(HabboHelpViewEnum.const_311);
               break;
            case CallForHelpResultEnum.const_1307:
               this.showUI(HabboHelpViewEnum.const_1378);
               break;
            case CallForHelpResultEnum.const_1211:
               this.showUI(HabboHelpViewEnum.const_1421);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_135.getValue(HabboHelpViewEnum.const_225) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_580));
      }
      ...
      {
         return this.var_135.getValue(this.var_389);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2574 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2576;
         this._window.width = _loc1_.width + this.var_2574;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_578.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_389 == HabboHelpViewEnum.const_225)
         {
            return;
         }
         if(this.var_700.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_700.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_700.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_390.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_700[1],this.var_700[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_700[0],this.var_700[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_389 == HabboHelpViewEnum.const_225 || this.var_578.length == 0)
         {
            return;
         }
         if(this.var_390 == null)
         {
            ...
            this.var_390 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_390.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_390.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_390 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_390 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_390 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
