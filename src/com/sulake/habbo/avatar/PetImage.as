package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_273:AvatarImageCache;
      
      private var var_636:int = 0;
      
      private var var_1784:int = 0;
      
      private var var_754:AvatarFigureContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_754 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_754.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1690 = this.var_1214;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_56)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1690);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_311.definition.geometryType);
         if(this.var_48 == null || _loc4_ != null && (this.var_48.width != _loc4_.width || this.var_48.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_311.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_636);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_754,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1690 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_636);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_636);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_754,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_112)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_636);
         ...
         switch(param1)
         {
            case AvatarAction.const_453:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_2003:
                  case AvatarAction.const_1840:
                  case AvatarAction.const_1212:
                  case AvatarAction.const_1372:
                  case AvatarAction.const_2017:
                  case AvatarAction.const_1958:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1131);
         this.getCache().resetBodyPartCache(this.var_1131);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1689 = this._structure.sortActions(this.var_360);
         ...
         {
            this.var_836 = this._structure.getCanvasOffsets(this.var_1689,this._scale,this.var_101);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1689)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_401)
               {
                  this.var_1127 = true;
               }
               ...
               if(_loc1_.actionType == AvatarAction.const_352)
               {
                  this.var_1127 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1214 = _loc4_.id;
                     this.var_1794 = _loc4_.breed;
                     break;
                  }
               }
            }
