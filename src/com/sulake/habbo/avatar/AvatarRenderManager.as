package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2396:String = "hd-99999-99999";
      ...
      private var var_346:PetDataManager;
      
      private var var_868:PaletteManager;
      
      private var var_660:String;
      
      private var var_345:Map;
      
      private var var_256:AvatarAssetDownloadManager;
      
      private var var_2097:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_660 = RenderMode.const_2004;
         this.var_345 = new Map();
         this.var_122 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_137,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_122.add(AvatarType.const_137,_loc4_);
         ...
         this.var_122.add(AvatarType.const_54,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_346 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_868 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_346.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_256)
         {
            this.var_256.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_346.init();
         this.var_868.init();
         _loc2_ = this.var_122.getValue(AvatarType.const_137) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_122.getValue(AvatarType.const_54) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_122.getValue(AvatarType.const_137) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_256 == null)
               {
                  ...
                  this.var_256 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_256.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1053)
         {
            if(this.var_2897 && this.var_2899 && this.var_2898)
            {
               this.var_1053 = true;
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_256.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_256.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_122.getValue(AvatarType.const_137) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_256.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_2097)
         {
            this.var_2097 = new AvatarFigureContainer(this.const_2396);
         }
         this.var_256.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2097,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(param1 == null || this.var_345 == null)
         {
            return;
         }
         for each(_loc2_ in this.var_345.getKeys())
         {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_346.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1820)
         {
            _loc6_ = !this.var_346.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_346.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_122.getValue(AvatarType.const_54) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_345.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_346.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_122.getValue(AvatarType.const_54);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_345.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_345.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_122.getValue(AvatarType.const_137) as AvatarStructure;
      ...
      {
         return this.var_346 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_137:
               _loc3_ = this.var_122.getValue(AvatarType.const_137) as AvatarStructure;
               break;
            case AvatarType.const_54:
               _loc3_ = this.var_122.getValue(AvatarType.const_54) as AvatarStructure;
               break;
            default:
