package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1594:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1595:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_560:HabboAvatarEditorManager;
      
      private var var_1032:IFigureData;
      ...
      private var var_1291:IHabboAvatarEditorDataSaver = null;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_560 = param2;
         this.var_1032 = this.var_560.avatarRenderManager.getFigureData(AvatarType.const_137);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            for each(_loc2_ in this.var_559)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_682["null"] = new FigureData(this);
         this.var_682["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_682["null"];
         var _loc3_:FigureData = this.var_682["null"];
         _loc2_.loadAvatarData(const_1594,FigureData.const_90);
         _loc3_.loadAvatarData(const_1595,FigureData.FEMALE);
         this.var_117 = new Map();
         this.var_559 = new Map();
         this.var_117.add(AvatarEditorFigureCategory.const_864,new BodyModel(this));
         this.var_117.add(AvatarEditorFigureCategory.const_56,new HeadModel(this));
         this.var_117.add(AvatarEditorFigureCategory.const_266,new TorsoModel(this));
         this.var_117.add(AvatarEditorFigureCategory.const_945,new LegsModel(this));
         if(param1 == null || param1.indexOf(AvatarEditorFigureCategory.HOTLOOKS) > -1)
         {
            this.var_117.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
         }
         this.var_559.add(AvatarEditorSideCategory.const_109,new WardrobeModel(this));
         this.var_559.add(AvatarEditorSideCategory.const_554,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_829 != param3)
         {
            this.var_829 = param3;
            _loc4_ = true;
         }
         var _loc5_:FigureData = this.var_682[param2];
         if(_loc5_ == null)
         {
            return;
         }
         ...
         if(this.var_2404 != param1)
         {
            this.var_2404 = param1;
            _loc4_ = true;
         }
         if(this.var_117 && _loc4_)
         {
            for each(_loc6_ in this.var_117)
            {
               _loc6_.reset();
            }
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1032.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1032.getPalette(param1);
      }
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_864);
         }
      }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = this.var_117.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:ISideContentModel = this.var_559.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         return this.var_682[this._gender];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         {
            this.var_1291.saveFigure(_loc1_,_loc2_);
         }
         else
         {
            _loc3_ = new UpdateFigureDataMessageComposer(_loc1_,_loc2_);
            this.var_560.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1989;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_829 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_695)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1716.clone() as IWindowContainer,param1,_loc13_);
                     _loc4_[_loc17_].push(_loc18_);
                     _loc17_++;
                  }
                  if(param2 != FigureData.const_86)
                  {
                     _loc19_ = 0;
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_560.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_560.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_560.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
                  _loc22_ = (_loc21_.content as BitmapData).clone();
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1421.clone() as IWindowContainer,param1,null,null,false);
                  _loc7_.iconImage = _loc22_;
                  _loc3_.push(_loc7_);
               }
            }
            _loc16_ = param2 != FigureData.const_86;
            for each(_loc6_ in _loc8_.partSets)
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1987)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_829 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1421.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      {
         return this.var_560.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_829 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_559.getValue(AvatarEditorSideCategory.const_109);
      }
