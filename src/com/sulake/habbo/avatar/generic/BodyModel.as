package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyModel extends CategoryBaseModel implements IAvatarEditorCategoryModel, IAvatarImageListener
   {
      ...
      {
         super.init();
         initCategory(FigureData.const_86);
         _isInitialized = true;
         if(!_view)
         {
      ...
      {
         var _loc4_:CategoryData = var_117[param1];
         if(_loc4_ == null)
         {
            return;
         }
         ...
         this.updateSelectionsFromFigure(FigureData.const_86);
      }
      ...
      override protected function updateSelectionsFromFigure(param1:String) : void
      {
         ...
         var _loc2_:int = var_27.figureData.getPartSetId(FigureData.const_86);
         var _loc3_:Array = var_27.figureData.getColourIds(FigureData.const_86);
         var _loc4_:CategoryData = var_117[param1];
         if(_loc4_ == null)
         {
            return;
