package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1464:String = "Default";
      
      private static const const_1463:int = 2;
      
      private static const const_1465:String = AvatarSetType.const_42;
      ...
      protected var var_754:AvatarFigureContainer;
      
      protected var var_610:IAvatarDataContainer;
      
      protected var var_360:Array;
      
      protected var var_48:BitmapData;
      
      private var var_1131:IActiveActionData;
      ...
      private var var_2386:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1465,const_1463);
         this.var_360 = new Array();
         this.var_1131 = new ActiveActionData(AvatarAction.const_450);
         this.var_1131.definition = this._structure.getActionDefinition(const_1464);
         this.resetActions();
         this.var_773 = new Map();
      }
      ...
      {
         return this._structure.getPartColor(this.var_754,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1784;
         if(param2 < AvatarDirectionAngle.const_1224)
         {
            param2 = AvatarDirectionAngle.const_368 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_368)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_636,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_268.length == 1 && this.var_101 == this.var_1757)
         {
            return this.var_101 + this.var_528 + this.var_636 % 4;
         }
         if(this.var_268.length == 2)
         {
            for each(_loc1_ in this.var_268)
            {
               ...
               {
                  return this.var_101 + this.var_528 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_636 % 11;
                  return this.var_101 + "_" + this.var_1757 + this.var_528 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2384 || param2 != this.var_2386 || param1 != this.var_2385)
         {
            this.var_2384 = param3;
            this.var_2386 = param2;
            this.var_2385 = param1;
            this.var_1785 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1424 || this.var_48 == null || (this.var_48.width != _loc5_.width || this.var_48.height != _loc5_.height))
         {
            if(this.var_48 != null && !this.var_1424)
            {
               this.var_48.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_636);
         ...
         if(this.var_610 != null)
         {
            if(this.var_610.paletteIsGrayscale)
            {
               ...
               this.var_48 = _loc13_;
               this.var_48.paletteMap(this.var_48,this.var_48.rect,new Point(0,0),this.var_610.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_636);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_360.push(new ActiveActionData(param1,param2,this.var_636));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_311 = this.var_1131;
         this.var_311.definition = this.var_1131.definition;
         this.resetBodyPartCache(this.var_1131);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_268)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_528 = "";
         this.var_268 = this._structure.sortActions(this.var_360);
         if(this.var_268 == null)
         {
         ...
         {
            this.var_836 = this._structure.getCanvasOffsets(this.var_268,this._scale,this.var_101);
            for each(_loc4_ in this.var_268)
            {
               this.var_528 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_354)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1473 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1473 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1184 != this.var_528)
            {
               _loc1_ = true;
               this.var_1184 = this.var_528;
            }
         }
         this.var_1472 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_268)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_1127 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1784 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_352 || _loc1_.actionType == AvatarAction.const_275 || _loc1_.actionType == AvatarAction.const_401)
               {
                  this.var_1127 = true;
               }
            }
