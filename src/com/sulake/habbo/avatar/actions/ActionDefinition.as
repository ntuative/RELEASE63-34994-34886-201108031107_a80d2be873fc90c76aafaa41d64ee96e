package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_1811:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_1811 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2722 = parseInt(param1.@precedence);
         this.var_2723 = String(param1.@activepartset);
         this.var_2726 = String(param1.@assetpartdefinition);
         this.var_2724 = String(param1.@lay);
         this.var_792 = String(param1.@geometrytype);
         this.var_2468 = Boolean(parseInt(param1.@main));
         this.var_2725 = Boolean(parseInt(param1.@const_2363));
         this.var_2728 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2727 = _loc6_;
            }
            else
            {
               this.var_1811[_loc5_] = _loc6_;
            }
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1811[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2727;
         }
         return _loc2_;
      }
