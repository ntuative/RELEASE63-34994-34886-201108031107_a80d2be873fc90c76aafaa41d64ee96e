package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1968:AvatarSet;
      
      private var var_819:Dictionary;
      
      private var var_1967:Dictionary;
      
      private var var_1268:Matrix4x4;
      
      private var var_1015:Vector3D;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc15_:* = null;
         var _loc16_:* = null;
         this.var_1015 = new Vector3D(0,0,10);
         super();
         this.var_1268 = new Matrix4x4();
         this.var_819 = new Dictionary();
         this.var_1967 = new Dictionary();
         this.var_1968 = new AvatarSet(param1.avatarset[0]);
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1015.x = _loc11_;
            this.var_1015.y = _loc12_;
            this.var_1015.z = _loc13_;
         }
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_1967[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = this.var_1968.findAvatarSet(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:AvatarSet = this.var_1968.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = this.var_175[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_1967[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         this.var_1268 = Matrix4x4.getYRotationMatrix(param2);
         for each(_loc7_ in _loc5_)
         {
            _loc7_.applyTransform(this.var_1268);
            _loc9_ = _loc7_.getDistance(this.var_1015);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            this.var_1268 = Matrix4x4.getYRotationMatrix(param3);
            return _loc5_.getParts(this.var_1268,this.var_1015,param4);
         }
         return [];
      }
