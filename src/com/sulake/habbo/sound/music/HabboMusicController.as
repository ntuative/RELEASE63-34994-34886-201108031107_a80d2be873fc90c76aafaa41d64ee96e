package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1631:int = HabboMusicPrioritiesEnum.const_120;
      ...
      private var var_574:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_869.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_869.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_869)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_860,this.onJukeboxInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_285,this.onJukeboxDispose);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_979,this.onSoundMachineInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_984,this.onSoundMachineDispose);
         this.var_1310 = new Timer(1000);
         this.var_1310.start();
         this.var_1310.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2036)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_426)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_869)
               {
            ...
            if(this.var_92)
            {
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_860,this.onJukeboxInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_285,this.onJukeboxDispose);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_979,this.onSoundMachineInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_984,this.onSoundMachineDispose);
            }
      ...
      {
         if(this.var_694.getValue(param1) == null)
         {
            this.var_694.add(param1,param2);
            this.var_850.push(param1);
         }
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_283.length)
         {
            ...
            if(_loc3_.id != this.var_1597 && _loc4_ != null && _loc4_.ready)
            {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_850));
         Logger.log("Requested song info\'s : " + this.var_850);
         this.var_850 = new Array();
      }
      ...
      private function playSongObject(param1:int, param2:int) : Boolean
      {
         ...
         this.var_2036 = this.getSongRequestCountAtPriority(param1);
         this.var_1597 = param2;
         if(this._priorityPlaying <= const_1631)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_120)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2794 != param1.id || _loc3_ > this.var_2795 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2794 = param1.id;
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_694.getValue(param1);
      }
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_574 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_92,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_574 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
