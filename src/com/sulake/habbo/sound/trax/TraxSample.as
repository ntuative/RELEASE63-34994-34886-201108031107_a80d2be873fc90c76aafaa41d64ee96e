package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1836:String = "sample_44khz";
      
      public static const const_1869:String = "sample_22khz";
      
      public static const const_1774:String = "sample_11khz";
      
      public static const const_1933:String = "sample_16bit";
      
      public static const const_1894:String = "sample_8bit";
      
      public static const SAMPLE_VALUE_MULTIPLIER:Number = 0.000030517578125;
      
      private static const const_1152:int = 32;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_186 * this.var_90;
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1152)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1152);
            }
            ...
            _loc9_ *= _loc5_;
            _loc9_ += _loc14_;
            if(_loc11_ % this.var_186 == this.var_186 - 1)
            {
               this.var_140[int(_loc11_ / this.var_186)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_140.length * this.var_186 * this.var_90;
      }
      
      public function get usageCount() : int
      {
         return this.var_732.length;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_186 * this.var_90;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
         ...
         if(this.var_90 == 1)
         {
            if(this.var_186 == 2)
            {
               while(_loc6_-- > 0)
               {
                  ...
                  var _loc11_:*;
                  param1[_loc11_ = param2++] = (_loc8_ >> 16 & const_200) - const_201;
                  var _loc12_:*;
                  param1[_loc12_ = param2++] = (_loc8_ & const_200) - const_201;
               }
            }
            else if(this.var_186 == 4)
            {
               while(_loc6_-- > 0)
               {
                  _loc8_ = this.var_140[param4++];
         ...
         else if(this.var_90 >= 2)
         {
            ...
            if(this.var_186 == 2)
            {
               ...
               {
                  _loc8_ = this.var_140[param4++];
                  _loc10_ = int((_loc8_ >> 16 & const_200) - const_201);
                  _loc9_ = this.var_90;
                  while(_loc9_ > 0)
                  {
                  ...
                  _loc10_ = int((_loc8_ & const_200) - const_201);
                  _loc9_ = this.var_90;
                  while(_loc9_ > 0)
                  {
                     param1[_loc11_ = param2++] = _loc10_;
      ...
      public function addSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         if(this.var_90 == 1)
         {
            if(this.var_186 == 2)
            {
               while(_loc6_-- > 0)
               {
                  ...
                  var _loc10_:*;
                  param1[_loc10_ = param2++] = param1[_loc10_] + ((_loc7_ >> 16 & const_200) - const_201);
                  var _loc11_:*;
                  param1[_loc11_ = param2++] = param1[_loc11_] + ((_loc7_ & const_200) - const_201);
               }
            }
            else if(this.var_186 == 4)
            {
         ...
         else if(this.var_90 >= 2)
         {
            ...
            if(this.var_186 == 2)
            {
               ...
               {
                  _loc7_ = this.var_140[param4++];
                  _loc9_ = int((_loc7_ >> 16 & const_200) - const_201);
                  _loc8_ = this.var_90;
                  while(_loc8_ > 0)
                  {
                  ...
                  _loc9_ = int((_loc7_ & const_200) - const_201);
                  _loc8_ = this.var_90;
                  while(_loc8_ > 0)
                  {
                     param1[_loc10_ = param2++] = param1[_loc10_] + _loc9_;
      ...
      public function isUsedFromSong(param1:int) : Boolean
      {
         ...
         return this.var_732.indexOf(param1) != -1;
      }
   }
}
