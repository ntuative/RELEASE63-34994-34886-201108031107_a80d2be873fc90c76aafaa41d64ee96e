package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_2047:uint = 2;
       
      
      private var var_1488:IProtocolEncoder;
      ...
      {
         super();
         this.var_1488 = new WedgieEncoder();
         this.var_1197 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1197.getID(_loc4_);
