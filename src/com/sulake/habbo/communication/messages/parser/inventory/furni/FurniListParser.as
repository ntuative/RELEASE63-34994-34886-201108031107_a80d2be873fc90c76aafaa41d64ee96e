package com.sulake.habbo.communication.messages.parser.inventory.furni
{
   ...
   public class FurniListParser implements IMessageParser
   {
      ...
      protected var var_3086:String;
      
      protected var var_3087:int;
      
      protected var var_3085:int;
      
      protected var var_1722:Array;
      ...
      {
         this.var_3086 = param1.readString();
         this.var_3087 = param1.readInteger();
         this.var_3085 = param1.readInteger();
         this.var_1722 = new Array();
         var _loc2_:int = param1.readInteger();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            this.var_1722.push(this.parseItem(param1));
            _loc3_++;
         }
         return true;
      }
