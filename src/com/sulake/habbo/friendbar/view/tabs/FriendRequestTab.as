package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const const_2077:String = "friend_request_tab_xml";
      ...
      protected static const const_1041:String = "click_region_reject";
      
      protected static const REGION_REJECT_TEXT:String = "link_reject";
      
      private static const const_75:uint = 16435481;
      
      private static const const_1073:uint = 16767334;
      
      private static const REGION_REJECT_COLOR_EXPOSED:uint = 16770666;
      
      private static const const_1656:uint = 16777215;
      
      private static var var_1625:FriendRequestTab;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1625 ? var_1625 : new FriendRequestTab();
      ...
      {
         var _loc6_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2077).content as XML) as IWindowContainer;
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_333,WindowStyle.const_104,WindowParam.const_29,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_428,WindowStyle.const_104,WindowParam.const_32,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case const_2076:
                  var_357.acceptFriendRequest(var_164.id);
                  break;
               case const_1431:
                  if(selected)
                  {
                  ...
                  break;
               case const_1041:
                  var_357.declineFriendRequest(var_164.id);
            }
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == const_1041)
            {
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1041)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1656;
            }
         }
      }
