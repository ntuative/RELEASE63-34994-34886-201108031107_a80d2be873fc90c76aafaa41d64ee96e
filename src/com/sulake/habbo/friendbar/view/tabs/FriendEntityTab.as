package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1587:String = "entity_xml";
      
      private static const const_1589:String = "facebook_piece_xml";
      
      private static const const_1590:String = "controls_piece_xml";
      
      protected static const const_1040:String = "pieces";
      
      protected static const const_385:String = "icons";
      
      protected static const const_462:String = "header";
      
      protected static const const_1433:String = "facebook";
      
      protected static const const_1432:String = "controls";
      
      protected static const const_316:String = "canvas";
      
      protected static const const_703:String = "name";
      
      protected static const const_1117:String = "btn_message";
      
      protected static const const_1039:String = "icon_message";
      
      protected static const const_1434:String = "btn_visit";
      
      protected static const ICON:String = "icon";
      
      protected static const const_1043:String = "label";
      
      protected static const const_677:String = "notification";
      
      private static const const_75:uint = 10338138;
      
      private static const const_1073:uint = 13891476;
      
      private static const const_1096:String = null;
      
      private static const const_694:String = "icon_tag_notify";
      
      private static const const_1588:String = "icon_tag_message";
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:IItemListWindow = IItemListWindow(param1.getChildByName(const_1040));
         _loc3_ = _loc2_.getListItemByName(const_1433) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         _loc3_ = _loc2_.getListItemByName(const_1432) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_677,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            _loc2_ = IItemListWindow(window.getChildByName(const_1040));
            _loc5_ = false;
            if(this.friend.realName != null && this.friend.realName != "")
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1589).content as XML) as IWindowContainer;
               _loc3_.name = const_1433;
               _loc6_ = _loc3_.getChildByName(const_703) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2262.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1590).content as XML) as IWindowContainer;
               _loc3_.name = const_1432;
               _loc8_ = _loc3_.getChildByName(const_1117);
               if(_loc8_)
               {
                  _loc8_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClick);
               }
               _loc8_ = _loc3_.getChildByName(const_1434);
               if(_loc8_)
               {
      ...
      {
         super.expose();
         _window.color = !!exposed ? uint(const_1073) : uint(const_75);
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_164)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1040)).getListItemByName(const_462) as IWindowContainer;
            _loc1_.findChildByName(const_703).caption = this.var_164.name;
            var_2262.crop(_loc1_.getChildByName(const_703) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_316));
            _loc2_.bitmap = var_510.getAvatarFaceBitmap(this.var_164.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_476.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1587).content as XML) as IWindowContainer;
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               case const_1117:
               case const_1039:
                  this.removeNotificationToken(FriendNotification.const_443,true);
                  if(var_357 && this.var_164)
                  {
                     var_357.startConversation(this.var_164.id);
                     this.deselect(true);
                     if(param1.window.name == const_1039)
                     {
                        var_510.setMessengerIconNotify(false);
                     }
                  }
                  break;
               case const_1434:
                  if(var_357 && this.var_164)
                  {
                     var_357.followToRoom(this.var_164.id);
                     this.deselect(true);
                  }
            }
         }
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         var _loc5_:String = const_1096;
         switch(param1.typeCode)
         {
            case FriendNotification.const_1396:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2232);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_694;
               break;
            case FriendNotification.const_1316:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2232);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_694;
               break;
            case FriendNotification.const_443:
               _loc4_ = new MessengerToken(this.friend,param1,param2);
               _loc4_.iconElement.name = const_1039;
