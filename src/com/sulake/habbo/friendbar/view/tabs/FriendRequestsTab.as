package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2079:String = "friend_requests_tab_xml";
      ...
      protected static const const_2080:String = "badge_counter";
      
      protected static const const_2081:String = "button_accept_all";
      
      protected static const const_2078:String = "click_area_discard_all";
      
      protected static const const_1431:String = "button_close";
      
      protected static const const_2076:String = "button_accept";
      
      protected static const const_1042:String = "click_area_discard";
      
      protected static const const_1438:String = "text_discard";
      
      private static var var_1625:FriendRequestsTab;
      
      private static const const_75:uint = 4294625561;
      
      private static const const_1073:uint = 4294957414;
      
      private static const const_1534:uint = 4289431312;
      
      private static const const_1537:uint = 4290616362;
      
      private static const REGION_REJECT_COLOR_EXPOSED:uint = 16770666;
      
      private static const const_1656:uint = 16777215;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1625 ? var_1625 : new FriendRequestsTab();
         _loc2_.var_168 = false;
         _loc2_._requests = param1;
         _loc2_._window.findChildByName(const_2080).caption = String(param1.length);
         return _loc2_;
      }
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_2124)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1353.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1534) : uint(const_1537);
                           _loc5_ = this._requests[_loc8_];
                           _loc4_.id = _loc5_.id;
                           _loc4_.getChildByName(const_703).caption = _loc5_.name;
      ...
      {
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2079).content as XML) as IWindowContainer;
         ...
         this.var_1353 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == const_1042)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1438)).textColor = REGION_REJECT_COLOR_EXPOSED;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1042)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1438)).textColor = const_1656;
            }
         }
      }
