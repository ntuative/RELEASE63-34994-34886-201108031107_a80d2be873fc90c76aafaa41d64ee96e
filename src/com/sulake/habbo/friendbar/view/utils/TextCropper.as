package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class TextCropper implements IDisposable
   {
      ...
      private var var_1051:TextFormat;
      ...
      public function TextCropper()
      {
         ...
         this.var_1051 = this.var_575.defaultTextFormat;
      }
      ...
      {
         var _loc3_:int = 0;
         this.var_1051.font = param1.fontFace;
         this.var_1051.size = param1.fontSize;
         this.var_1051.bold = param1.bold;
         this.var_1051.italic = param1.italic;
         this.var_575.setTextFormat(this.var_1051);
         this.var_575.text = param1.getLineText(0);
         var _loc2_:int = this.var_575.textWidth;
         if(_loc2_ > param1.width)
         {
            _loc3_ = this.var_575.getCharIndexAtPoint(param1.width - this.var_3109,this.var_575.textHeight / 2);
