package com.sulake.habbo.friendbar.view
{
   ...
   public class HabboFriendBarView extends AbstractView implements IHabboFriendBarView, IAvatarImageListener
   {
      ...
      private static const const_1717:int = 127;
      
      private static const const_487:int = 1;
      
      private static const const_1713:int = 2;
      
      private static const const_721:int = 3;
      
      private static const const_1148:int = 3;
      
      private static const const_1705:Boolean = false;
      
      private static const const_722:int = 3;
      
      private static const const_1706:String = "arrow";
      
      private static const const_1703:String = "left";
      
      private static const const_1708:String = "right";
      
      private static const const_1714:String = "bar_xml";
      
      private static const const_1716:String = "toggle_xml";
      
      private static const const_71:String = "container";
      
      private static const const_1149:String = "wrapper";
      
      private static const const_1715:String = "border";
      ...
      private static const const_1711:String = "button_left";
      
      private static const BUTTON_RIGHT_SINGLE:String = "button_right";
      
      private static const const_1702:String = "button_left_page";
      
      private static const const_1707:String = "button_right_page";
      
      private static const const_1704:String = "button_left_end";
      
      private static const const_1712:String = "button_right_end";
      
      private static const const_1431:String = "button_close";
      
      private static const const_1710:String = "button_open";
      
      private static const const_1709:String = "link_friendlist";
      
      private static const const_1151:String = "messenger";
      
      private static const const_1150:String = "friendlist";
      
      private static const const_720:String = "stream";
      
      private static const const_2129:String = "stream_new_label";
      ...
      private var var_600:FriendListIcon;
      
      private var var_413:MessengerIcon;
      
      private var var_892:StreamIcon;
         ...
         if(!disposed)
         {
            ...
            if(this.var_47)
            {
               if(!this.var_47.disposed)
               {
                  ...
                  {
                     this.var_47.events.removeEventListener(FriendBarUpdateEvent.const_770,this.onRefreshView);
                     this.var_47.events.removeEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
                     this.var_47.events.removeEventListener(FriendRequestUpdateEvent.const_918,this.onFriendRequestUpdate);
                     this.var_47.events.removeEventListener(NewMessageEvent.const_751,this.onNewInstantMessage);
                     this.var_47.events.removeEventListener(NotificationEvent.const_902,this.onFriendNotification);
                  }
            ...
            if(_windowManager)
            {
               if(true)
               {
                  _windowManager.getWindowContext(const_487).getDesktopWindow().removeEventListener(WindowEvent.const_41,this.onDesktopResized);
               }
            }
      ...
      public function populate() : void
      {
         ...
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc1_:int = this.var_1107;
         this.deSelect(false);
         var _loc2_:IWindowContainer = this.var_46.findChildByName(const_71) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_691) as IItemListWindow;
         ...
         var _loc9_:int = _loc6_ + (!!this.var_1662 ? 1 : 0) + (_loc7_ > 0 ? 1 : 0);
         ...
         if(this.var_1662)
         {
            ...
            {
               _loc15_ = 1;
               if(this.var_77.length + _loc15_ < const_722)
               {
                  _loc15_ = Math.min(_loc8_ - this.var_77.length,const_722 - this.var_77.length);
               }
      ...
      private function onFriendBarDataAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_47.events.addEventListener(FriendBarUpdateEvent.const_770,this.onRefreshView);
         this.var_47.events.addEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
         this.var_47.events.addEventListener(FriendRequestUpdateEvent.const_918,this.onFriendRequestUpdate);
         this.var_47.events.addEventListener(NewMessageEvent.const_751,this.onNewInstantMessage);
         this.var_47.events.addEventListener(NotificationEvent.const_902,this.onFriendNotification);
      }
      ...
      {
         var _loc2_:* = null;
         Tab.var_357 = this.var_47;
         Tab.var_510 = this;
         Tab.ASSETS = assets;
         Tab.WINDOWING = _windowManager;
         Tab.var_2232 = var_431;
         Tab.var_2262 = this.var_1663;
         Token.WINDOWING = _windowManager;
         Token.ASSETS = assets;
         var _loc1_:IAsset = assets.getAssetByName(const_1714);
         this.var_46 = _windowManager.buildFromXML(_loc1_.content as XML,const_487) as IWindowContainer;
         this.var_46.x = const_721;
         this.var_46.y = this.var_46.parent.height - (this.var_46.height + const_1713);
         this.var_46.width = this.var_46.parent.width - (const_721 + const_1148);
         this.var_46.setParamFlag(WindowParam.const_291,true);
         this.var_46.procedure = this.barWindowEventProc;
         if(const_1705)
         {
            _loc1_ = assets.getAssetByName(const_1716);
            this.var_232 = _windowManager.buildFromXML(_loc1_.content as XML,const_487) as IWindowContainer;
            this.var_232.x = this.var_46.x;
            this.var_232.y = this.var_46.y;
            this.var_232.setParamFlag(WindowParam.const_291,true);
            this.var_232.visible = false;
            this.var_232.procedure = this.toggleWindowEventProc;
         }
         _loc2_ = IWindowContainer(this.var_46.findChildByName(const_1150));
         ...
         this.var_600 = new FriendListIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         _loc2_ = IWindowContainer(this.var_46.findChildByName(const_1151));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_413 = new MessengerIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         this.var_413.enable(false);
         this.visible = true;
         _windowManager.getWindowContext(const_487).getDesktopWindow().addEventListener(WindowEvent.const_41,this.onDesktopResized);
         this.var_46.findChildByName(const_720).visible = var_762.getBoolean("friendbar.stream.enabled",false) == true;
         _loc2_ = IWindowContainer(this.var_46.findChildByName(const_720));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_892 = new StreamIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         var _loc3_:IItemListWindow = this.var_46.findChildByName(const_691) as IItemListWindow;
      ...
      {
         return this.var_1107 == param1.id;
      }
      ...
      public function selectTab(param1:ITab, param2:Boolean) : void
      {
         if(!param1.selected)
         {
            ...
            {
               this.var_1107 = FriendEntityTab(param1).friend.id;
            }
         }
      }
      ...
      private function onFindFriendsNotification(param1:FindFriendsNotificationEvent) : void
      {
         ...
         {
            param1.dispose();
         },HabboAlertDialogFlag.const_654);
      }
      ...
      private function onFriendRequestUpdate(param1:FriendRequestUpdateEvent) : void
      {
         if(this.var_600)
         {
            this.var_600.notify(this.var_47.numFriendRequests > 0);
         }
         this.populate();
      }
      ...
      private function onNewInstantMessage(param1:NewMessageEvent) : void
      {
         if(this.var_413)
         {
            if(param1.notify)
            {
               this.var_413.notify(true);
            }
            else
            {
               this.var_413.enable(true);
            }
         }
      }
      ...
      private function barWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43)
         {
            ...
            _loc4_ = this.var_47.numFriends + (!!this.var_1662 ? 1 : 0) + (this.var_47.numFriendRequests > 0 ? 1 : 0);
            switch(param2.name)
            {
               case const_1711:
         ...
         if(param1.type == WindowEvent.const_606)
         {
            this.deSelect(true);
         }
      }
      ...
      private function toggleArrowButtons(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:IWindowContainer = this.var_46.findChildByName(const_1149) as IWindowContainer;
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1706,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            _loc4_.visible = param1;
         }
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1703,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param2)
            {
         ...
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1708,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param3)
            {
         ...
         if(!disposed)
         {
            if(this.var_46)
            {
               ...
               if(!param1)
               {
                  ...
                  {
                     if(this.var_77.length < const_722)
                     {
                        param1 = true;
                     }
                     else if(this.var_77.length < this.var_47.numFriends + (!!this.var_1662 ? 1 : 0))
                     {
                        param1 = true;
                     }
      ...
      private function get maxNumOfTabsVisible() : int
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getChildByName(const_1149) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_691) as IItemListWindow;
         var _loc4_:int = _loc2_.width - _loc3_.width;
         return (_loc1_.width - _loc4_) / (const_1717 + _loc3_.spacing);
      }
