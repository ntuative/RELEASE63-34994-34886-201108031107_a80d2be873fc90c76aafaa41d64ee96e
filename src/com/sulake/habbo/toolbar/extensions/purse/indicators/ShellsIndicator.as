package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class ShellsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_469:Array = ["icon_shell_0_png","icon_shell_1_png","icon_shell_2_png","icon_shell_3_png"];
       
      
      private const const_1592:uint = 4.283212437E9;
      
      private const const_1591:uint = 4.282748017E9;
      ...
      public function ShellsIndicator(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboCatalog, param4:ICoreLocalizationManager)
      {
         ...
         this.bgColorLight = this.const_1592;
         this.bgColorDark = this.const_1591;
         this.textElementName = "amount";
         this.textElementShadowName = "amount_shadow";
         this.iconAnimationSequence = const_469.concat(const_469).concat(const_469);
         this.iconAnimationDelay = 50;
         this.amountZeroText = param4.getKey("purse.shells.zero.amount.text","Info");
         createWindow("purse_indicator_shells_xml",const_469[0]);
         this.setAmount(0);
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(PurseEvent.const_383,this.onShellBalance);
      }
      ...
      private function onShellBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_1865 != 0)
         {
            if(this.var_1865 > param1.balance)
            {
