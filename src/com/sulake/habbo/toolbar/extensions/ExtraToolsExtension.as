package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1563:uint = 16777215;
      
      private static const const_1564:uint = 12247545;
      
      private static const const_1565:String = "HELP";
      ...
      {
         this.var_62.removeListItem(this.var_419);
      }
      
      public function showRoomInfo() : void
      {
         this.var_62.addListItemAt(this.var_419,0);
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1565);
               break;
