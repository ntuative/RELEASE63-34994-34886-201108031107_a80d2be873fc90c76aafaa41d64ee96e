package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1557:Point = new Point(3,3);
      
      private static const const_1558:uint = 7433577;
      ...
      private static const const_1561:int = 600;
      
      private static const const_1559:int = 80;
      
      private static const const_1556:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1554:int = -2;
      
      private static const const_1560:int = 5;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1557;
         this._window.addEventListener(WindowEvent.const_662,this.onParentResized);
         ...
         this.var_218.x = _loc13_.width - this.var_218.width - const_475;
         this.var_218.y = const_475;
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1561;
         if(!param1 && _loc2_ == this.var_1557)
         {
            return;
         }
         this.var_1557 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1556) : int(const_1559);
         var _loc4_:int = !!_loc2_ ? int(const_1554) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1560 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1562;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_218 != null && this.var_2639)
               {
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_473 ? this.var_1556 : this.var_1558;
         }
         else
         {
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1557 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1557 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         if(this.var_1558)
         {
            this.var_1558.dispose();
         }
         this.var_1558 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1556)
         {
            this.var_1556.dispose();
         }
         this.var_1556 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1009.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.y = const_475;
            this.var_1009.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      {
         return this._config.getKey("toolbar.new_additions.notification.enabled","AnimationAction") == "true";
      }
   }
}
