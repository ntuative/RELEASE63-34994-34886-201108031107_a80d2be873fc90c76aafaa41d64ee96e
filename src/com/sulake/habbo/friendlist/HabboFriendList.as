package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_185:String = "face";
      ...
      private var var_152:IHabboMessenger;
      
      private var _configuration:IHabboConfigurationManager;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_949:IAvatarRenderManager;
      
      private var var_790:ISessionDataManager;
      
      private var var_2440:FriendListLookAndFeel;
      
      private var var_459:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1823:OpenedToWebPopup;
      
      private var var_2439:int;
      
      var var_117:FriendCategories;
      
      private var var_120:FriendRequests;
      
      private var var_1822:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_1100:IHabboNotifications;
      
      private var var_646:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2440 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_117 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1822 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_646.stop();
            this.var_646.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_646 = null;
         }
         ...
         if(this.var_152)
         {
            this.var_152.release(new IIDHabboMessenger());
            this.var_152 = null;
         }
         ...
         if(this.var_1100)
         {
            this.var_1100.release(new IIDHabboNotifications());
            this.var_1100 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_790)
         {
            this.var_790.release(new IIDSessionDataManager());
            this.var_790 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1823 = new OpenedToWebPopup(this);
         }
         this.var_1823.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_117.findFriend(param1);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_108);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_399);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_117.getFriendCount(param1,param2);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_361,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_949.createAvatarImage(param1,AvatarScaleType.const_112,null,this);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_56);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_152 = param2 as IHabboMessenger;
      ...
      {
         this.var_1100 = param2 as IHabboNotifications;
      ...
      {
         this.var_790 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_117.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_117.addCategory(new FriendCategory(FriendCategory.const_1424,this.getText("friendlist.friends")));
         this.var_117.addCategory(new FriendCategory(FriendCategory.const_397,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_117.addFriend(new Friend(_loc4_));
         }
         this.var_459 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_646)
         {
            this.var_646 = new Timer(120000);
            this.var_646.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_646.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         if(this.var_117.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_117.findCategory(FriendCategory.const_397);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_459.findTab(FriendListTab.const_93).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_459.findTab(FriendListTab.const_93);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1822.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_117.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_117.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_459.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_459.findTab(FriendListTab.const_93);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_790 || !this.var_120)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_790.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_36))
         {
            _loc2_ = this.var_120.vipLimit;
         }
         else if(this.var_790.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_33))
         {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(disposed || this.var_117 == null)
         {
            return;
         }
         var _loc2_:Dictionary = this.var_117.getAllFriends();
         if(_loc2_ == null)
         {
            return;
         }
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_185) as IBitmapWrapperWindow;
