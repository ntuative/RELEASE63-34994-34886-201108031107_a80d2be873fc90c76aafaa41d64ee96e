package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1557:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2182:FriendListTabsView;
      ...
      private var var_1683:ITextWindow;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_2182 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_16.position = const_1557;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_985 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_295 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_2182.prepare(this.var_985);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1353,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1197,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_756,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_996,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_756,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_996,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1683 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1683.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_2184 == -1 ? 0 : int(this.var_16.height - this.var_2184);
         var _loc4_:int = this.var_2183 == -1 ? 0 : int(this.var_16.width - this.var_2183);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_295.y = Util.getLowestPoint(this.var_16.content);
         this.var_295.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1302,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_756,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1353,false);
         ...
         this.var_2184 = this.var_16.height;
         this.var_2183 = this.var_16.width;
