package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_433:int = 100;
      ...
      {
         var _loc4_:* = null;
         if(this.var_241.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         {
            _loc4_ = this.var_241[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               this.var_241.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
         this.var_241.push(param1);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean = false) : int
      {
         var _loc4_:* = null;
         var _loc3_:int = 0;
         for each(_loc4_ in this.var_241)
         {
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_241,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         if(this.var_967 >= this.getPageCount())
         {
            this.var_967 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_241.length / const_433);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_967 * const_433;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_967 + 1) * const_433,this.var_241.length);
      }
