package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1081:int = 100;
      
      private static const const_1529:int = 20;
       
      
      private var var_152:HabboMessenger;
      
      private var var_2559:IScrollbarWindow;
      
      private var var_1912:IContainerButtonWindow;
      
      private var var_62:IItemListWindow;
      
      private var var_545:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_152 = param1;
         this.var_1912 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_62 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2559 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_152.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1081 + const_1529)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_152.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1528;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_545 == null || _loc1_.id != this.var_545.id)
         {
            this.var_545 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_545.followingAllowed)
         {
            this.var_1912.enable();
         }
         else
         {
            this.var_1912.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_62.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_545.messages.length - const_1081);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_545.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_545.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_152.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_906 || param3.type == Message.const_955 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_545.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_152.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_152.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_152.send(new FollowFriendMessageComposer(this.var_545.id));
         this.var_152.send(new EventLogMessageComposer("Navigation","IM","go.im"));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_152.conversations.closeConversation();
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_955)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1190)
         {
            return 4294927974;
         }
         if(param1 == Message.const_857)
         {
            return 4293454056;
         }
         if(param1 == Message.const_991)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1417)
         {
            return 4288269465;
         }
         return 4291611852;
