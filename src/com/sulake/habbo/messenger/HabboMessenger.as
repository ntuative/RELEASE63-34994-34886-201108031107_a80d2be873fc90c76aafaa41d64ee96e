package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_462:Conversations;
      
      private var var_201:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this._configuration && this._localization && this._friendList && this.var_949 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_462 = new Conversations(new ConversationsDeps(this));
         this.var_201 = new MessengerView(this);
      ...
      {
         var _loc2_:Conversation = this.var_462.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_462.setSelected(_loc2_);
            this.var_201.openMessenger();
            this.var_201.refresh();
         }
      }
      
      public function getActiveConversation() : IConversation
      {
         return !!this.var_462 ? this.var_462.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_462.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_462.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         if(_loc2_)
         {
            _loc3_ = _loc2_.getImage(AvatarSetType.const_56,true);
            _loc2_.dispose();
            return _loc3_;
         }
         return null;
      ...
      {
         return this.var_201 && this.var_201.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_201)
         {
            if(this.var_201.isMessengerOpen())
            {
               this.var_201.close();
            }
            else
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_955,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1417,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_462.addMessageAndUpdateView(param1);
         if(!this.var_201.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1230);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1190,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_462.addMessageAndUpdateView(_loc3_);
      }
