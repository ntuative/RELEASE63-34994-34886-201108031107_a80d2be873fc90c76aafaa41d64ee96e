package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_212:String = "regular";
      ...
      private static var var_596:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_719:String = "{";
      
      private static const const_718:String = "}";
      
      private static const const_1699:String = "/*";
      
      private static const const_1698:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_99[const_212],var_99[ITALIC],var_99[BOLD]];
            var_99.reset();
            var_99[const_212] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_596.indexOf(_loc4_.name) == -1)
            {
               var_596.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_718);
         if(countSubStrings(param1,const_719) != countSubStrings(param1,const_718))
         {
            throw new Error("Mismatching amount of \"" + const_719 + "\" versus \"" + const_718 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1699) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1698) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_719)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
