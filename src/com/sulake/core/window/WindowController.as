package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1410:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1439:String = "_COLORIZE";
      
      protected static const const_1440:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1174:Point = new Point();
      ...
      protected var var_436:WindowRectLimits;
      
      private var var_1411:Boolean = false;
      
      private var var_425:Rectangle;
      
      private var var_3049:uint;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_425 = new Rectangle();
         if(_loc12_ != null)
         {
            var_434 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_68 = var_434.clone();
            var_10 = var_434.clone();
         ...
         if(_loc13_)
         {
            var_778 = _loc13_.blend;
            var_518 = _loc13_.var_3064;
      ...
      {
         return this.var_767 != null ? this.var_767 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      public function get limits() : IRectLimiter
      {
         if(!this.var_436)
         {
            this.var_436 = new WindowRectLimits(this);
         }
         return this.var_436;
      }
      ...
      {
         var_519 = param1;
         var_267 = !!var_519 ? uint(var_267 | var_618) : uint(var_267 & 16777215);
      ...
      {
         var_618 = param1 & 4278190080;
         var_267 = !!var_519 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_10,WindowRedrawFlag.const_62);
      }
      ...
      {
         var_618 = param1 << 24;
         var_267 = !!var_519 ? uint(var_618 | var_267) : uint(16777215 & var_267);
         _context.invalidate(this,var_10,WindowRedrawFlag.const_62);
      }
      
      public function set blend(param1:Number) : void
      {
         var_778 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_10,WindowRedrawFlag.const_1269);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_10,WindowRedrawFlag.const_804);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_91)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1440) == -1)
               {
                  _loc4_.style = var_91;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_425 = this._parent.rectangle.clone();
               var_68.x = var_10.x;
               var_68.y = var_10.y;
               var_68.width = var_10.width;
               var_68.height = var_10.height;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_599,this,this._parent);
            ...
            else
            {
               this.var_425.x = 0;
               this.var_425.y = 0;
               this.var_425.width = 0;
               this.var_425.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1799,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_995,var_10);
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_91,var_20,_context,var_10,null,this.var_767,this.properties,var_954.concat(),_id) as WindowController;
         _loc2_.var_518 = var_518;
         _loc2_.var_189 = this.var_189;
         _loc2_._debug = this._debug;
         _loc2_.var_425 = this.var_425.clone();
         _loc2_.var_10 = var_10.clone();
         _loc2_.var_434 = var_434.clone();
         _loc2_.var_68 = var_68.clone();
         _loc2_.var_166 = !!var_166 ? var_166.clone() : null;
         _loc2_.var_167 = !!var_167 ? var_167.clone() : null;
         _loc2_.var_436 = !!this.var_436 ? this.var_436.clone(_loc2_) : null;
         _loc2_._context = _context;
         _loc2_.var_267 = var_267;
         _loc2_.var_618 = var_618;
         _loc2_.var_765 = var_765;
         _loc2_.var_340 = var_340;
         _loc2_.var_778 = var_778;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_3049 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(this.var_436)
         {
            param4 = Math.max(this.var_436.minHeight,param4);
            param4 = Math.min(this.var_436.maxHeight,param4);
            param3 = Math.max(this.var_436.minWidth,param3);
            param3 = Math.min(this.var_436.maxWidth,param3);
         }
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_615)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_510)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_20 & 0);
            if(_loc7_ == WindowParam.const_587)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1283,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_447,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_954))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_43:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1278;
                  if(testParamFlag(WindowParam.const_441))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                  ...
                  if((var_20 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_382))
                        {
               ...
               case WindowMouseEvent.const_55:
                  ...
                  if(testParamFlag(WindowParam.const_382))
                  {
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_41:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_662,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_231,WindowParam.const_191))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_219,WindowParam.const_183))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc7_ = uint(var_20);
                        var_20 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_556))
                        {
                        ...
                        var_20 = _loc7_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_141,this._parent,this);
               ...
               case WindowEvent.const_447:
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1292);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1914,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_204,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_601:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1284,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_348,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_662:
                  this._parent.getRegionProperties(null,this.var_425);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowEvent.const_558:
         ...
         if(this.var_189 && var_518 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_10.width && param1.y <= var_10.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1174,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1174,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_91 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1440) == -1)
               {
                  _loc6_.style = var_91;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_174,WindowParam.const_191);
         var _loc2_:* = !testParamFlag(WindowParam.const_163,WindowParam.const_183);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_10.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_425.width;
               ...
               else if(_loc5_ == WindowParam.const_231)
               {
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_425.height;
               _loc5_ = uint(var_20 & 0);
               ...
               else if(_loc5_ == WindowParam.const_219)
               {
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1992,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1857,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_72,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1767,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1989,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_2052,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_601,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_606,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1826,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_2000,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_72,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1922,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_815,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_209,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_205,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_2037,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1772,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1411 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_558,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1411 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_558,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_452,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
