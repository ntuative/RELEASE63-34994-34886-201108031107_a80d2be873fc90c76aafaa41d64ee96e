package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1473:String = "increment";
      
      private static const const_1472:String = "decrement";
      
      private static const const_1052:String = "slider_track";
      ...
      protected var var_755:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_189 = false;
         this.var_17 = param12;
         this._horizontal = param2 == WindowType.const_546;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_17 != null && !this.var_17.disposed)
         {
            ...
            this.var_17.removeEventListener(WindowEvent.const_622,this.onScrollableScrolled);
         }
         this.var_17 = param1;
         if(this.var_17 != null && !this.var_17.disposed)
         {
            this.var_17.addEventListener(WindowEvent.const_41,this.onScrollableResized);
            this.var_17.addEventListener(WindowEvent.const_622,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_963 = _loc3_.value as String;
               this.var_17 = null;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1052) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_681:
               if(param2.type == WindowEvent.const_204)
               {
                  if(!this.var_1192)
                  {
                     if(this._horizontal)
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_365)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_755;
                  }
                  else
                  {
                     this.scrollV -= this.var_755;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43 || param1.type == WindowTouchEvent.const_839)
         {
            ...
            else if(param2.name == const_1472)
            {
               if(this.var_17)
               {
                  this.var_1192 = true;
            ...
            else if(param2.name == const_1052)
            {
         ...
         if(param1.type == WindowMouseEvent.const_365)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_963) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_963) as IScrollableWindow;
               if(_loc1_)
               {
