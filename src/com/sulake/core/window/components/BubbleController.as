package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2111:String = "_POINTER_UP";
      
      private static const const_2110:String = "_POINTER_DOWN";
      
      private static const const_2112:String = "_POINTER_LEFT";
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_843;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_802,this._direction,PropertyStruct.const_52,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1875);
         }
         if(this.var_843 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_861,this.var_843,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1798);
         }
         return _loc1_;
      }
