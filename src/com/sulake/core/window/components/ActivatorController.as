package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_348)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1284)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_950;
         if(this.var_950 != param1)
         {
            if(this.var_950 != null)
            {
               if(!this.var_950.disposed)
               {
                  this.var_950.deactivate();
               }
            }
            this.var_950 = param1;
