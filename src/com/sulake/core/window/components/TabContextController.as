package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1749:String = "_SELECTOR";
      
      private static const const_1750:String = "_CONTENT";
       
      
      protected var var_1167:ITabSelectorWindow;
      
      protected var var_2290:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1167 = findChildByTag(const_1749) as ITabSelectorWindow;
            if(this.var_1167 != null)
            {
               this.var_1167.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2290 == null)
         {
            this.var_2290 = findChildByTag(const_1750) as IWindowContainer;
         }
      ...
      {
         return !!this.var_805 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1167.numSelectables;
      }
