package com.sulake.core.window.components
{
   ...
   public class TabButtonController extends SelectableController implements ITabButtonWindow
   {
      ...
      private static const const_2126:String = "TAB_BUTTON_CONTENT";
      
      private static const const_1697:String = "TAB_BUTTON_TITLE";
      
      private static const const_2127:String = "TAB_BUTTON_ICON";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = findChildByTag(const_1697);
         if(_loc2_ != null)
         {
      ...
      {
         if(param2.type == WindowEvent.const_141)
         {
