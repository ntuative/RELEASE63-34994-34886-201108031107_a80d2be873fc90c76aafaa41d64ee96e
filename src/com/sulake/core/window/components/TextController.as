package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1435:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_951:Number;
      
      protected var var_615:Number;
      
      protected var var_614:Boolean;
      
      protected var var_42:TextMargins;
      
      protected var _autoSize:String = "none";
      
      protected var var_147:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_475,this._explicitStyle);
      ...
      private static function setTextMarginMap(param1:TextController, param2:Map) : void
      {
         if(param1.var_42)
         {
            param1.var_42.assign(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         else
         {
            param1.var_42 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         param1.refreshTextImage();
      }
      ...
      {
         if(param1.var_42 && param1.var_42.left != param2)
         {
      ...
      {
         if(param1.var_42 && param1.var_42.top != param2)
         {
      ...
      {
         if(param1.var_42 && param1.var_42.right != param2)
         {
      ...
      {
         if(param1.var_42 && param1.var_42.bottom != param2)
         {
      ...
      private static function method_11(param1:TextController, param2:Boolean) : void
      {
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_475 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_475,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_212);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_818 ? true : null;
         }
      ...
      {
         this.var_951 = param1;
         this._field.scrollH = this.var_951 * Number(this._field.maxScrollH);
         this.refreshTextImage();
      }
      
      public function set scrollV(param1:Number) : void
      {
         if(param1 > this.var_615)
         {
            this.var_615 = param1;
            this._field.scrollV = Math.max(this._field.scrollV,param1 * this._field.maxScrollV + 1);
            this.refreshTextImage();
         }
         else if(param1 < this.var_615)
         {
            this.var_615 = param1;
      ...
      {
         return new Rectangle(this.var_951 * this.maxScrollH,this.var_615 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_951 = this.var_951;
         _loc1_.var_615 = this.var_615;
         _loc1_.var_42 = this.var_42.clone(_loc1_.setTextMargins);
         _loc1_._autoSize = this._autoSize;
         _loc1_.var_147 = this.var_147;
         return _loc1_;
      }
      ...
      protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         this.var_614 = true;
         var _loc2_:int = this.var_42.left + this.var_42.right;
         var _loc3_:int = this.var_42.top + this.var_42.bottom;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_931,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1332));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1228 ? new PropertyStruct(PropertyDefaults.const_1033,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1183) : PropertyDefaults.const_1974);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_39,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_152,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_271,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1423 ? new PropertyStruct(PropertyDefaults.const_1187,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1216) : PropertyDefaults.const_1805);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_1011) ? new PropertyStruct(PropertyDefaults.const_421,this._field.textColor,PropertyStruct.const_152,true) : PropertyDefaults.const_1219);
         ...
         _loc1_.push(this.var_42.left != PropertyDefaults.const_794 ? new PropertyStruct(PropertyDefaults.const_273,this.var_42.left,PropertyStruct.const_35,true) : PropertyDefaults.const_813);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_871 ? new PropertyStruct(PropertyDefaults.const_278,this.var_42.top,PropertyStruct.const_35,true) : PropertyDefaults.const_1020);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_920 ? new PropertyStruct(PropertyDefaults.const_295,this.var_42.right,PropertyStruct.const_35,true) : PropertyDefaults.const_969);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_787 ? new PropertyStruct(PropertyDefaults.const_296,this.var_42.bottom,PropertyStruct.const_35,true) : PropertyDefaults.const_874);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1310 ? new PropertyStruct(PropertyDefaults.const_776,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1858);
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_35,this._field.maxChars != 0));
