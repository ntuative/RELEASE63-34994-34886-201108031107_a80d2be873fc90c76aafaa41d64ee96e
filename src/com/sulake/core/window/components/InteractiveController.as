package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_608)
         {
      ...
      public static function readInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : void
      {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_919:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_608)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_919,param1.toolTipCaption,PropertyStruct.const_52,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_2051);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1410)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_865,param1.toolTipDelay,PropertyStruct.const_271,true));
         }
         else
         {
      ...
      {
         this.var_1443 = param1 == null ? "null" : param1;
      }
