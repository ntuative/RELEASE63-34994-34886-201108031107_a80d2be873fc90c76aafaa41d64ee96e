package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1498:String = "_TITLE";
      
      private static const const_1500:String = "_HEADER";
      
      private static const const_1499:String = "_CONTENT";
      
      private static const const_1501:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1511:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1498) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1511 = findChildByTag(const_1500) as IHeaderWindow;
            if(!this.var_1511)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_203 = findChildByTag(const_1499) as IWindowContainer;
            if(!this.var_203)
            {
      ...
      {
         return findChildByTag(const_1501) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1439,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_382);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_308);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_283);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_308,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_308,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_338,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_273,_loc3_.left,PropertyStruct.const_35,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_278,_loc3_.top,PropertyStruct.const_35,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_295,0 - _loc3_.right,PropertyStruct.const_35,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_296,0 - _loc3_.bottom,PropertyStruct.const_35,_loc2_));
         return _loc1_;
      }
