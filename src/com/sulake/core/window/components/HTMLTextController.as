package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_976:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_795:String;
      
      private var var_1215:String = null;
      
      private var var_1857:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1215 == param2)
         {
            return;
         }
         param1.var_1215 = param2;
         param1.var_1857 = null;
         if(param1.var_1215 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1215);
            param1.var_1857 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_742.indexOf(param1) > -1)
         {
            this.var_795 = param1;
         }
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1857;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1255)
            {
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_975,this.var_795,PropertyStruct.const_52,true,PropertyDefaults.const_742));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1786);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_975)
            {
