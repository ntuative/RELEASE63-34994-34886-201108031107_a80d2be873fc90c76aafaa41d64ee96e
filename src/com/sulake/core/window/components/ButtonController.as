package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_1437:Number = 0.5;
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               ...
               case WindowEvent.const_209:
                  try
                  {
                     getChildByName(const_465).blend = getChildByName(const_465).blend + const_1437;
                  }
                  catch(e:Error)
                  {
                  }
                  break;
               case WindowEvent.const_205:
                  try
                  {
                     getChildByName(const_465).blend = getChildByName(const_465).blend - const_1437;
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_1418:
                  type = "null";
                  break;
               case WindowTouchEvent.const_839:
                  type = "null";
            }
