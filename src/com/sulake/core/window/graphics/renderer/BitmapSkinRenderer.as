package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_953:Dictionary;
      
      protected var var_952:Dictionary;
      
      private var var_284:Matrix;
      ...
      {
         super(param1);
         this.var_953 = new Dictionary(false);
         this.var_952 = new Dictionary(false);
         this.var_284 = new Matrix();
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_284 = null;
            this.var_853 = null;
            for(_loc1_ in this.var_953)
            {
               _loc2_ = this.var_953[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_953[_loc1_];
            }
            this.var_953 = null;
            for(_loc1_ in this.var_952)
            {
               _loc2_ = this.var_952[_loc1_] as BitmapData;
               _loc2_.dispose();
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_516[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               ...
               this.var_853.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_853);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_356 == SkinLayoutEntity.const_371)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_356 == SkinLayoutEntity.const_619)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_356 == SkinLayoutEntity.const_353)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_356 == SkinLayoutEntity.const_572)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_359 == SkinLayoutEntity.const_371)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_359 == SkinLayoutEntity.const_619)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_359 == SkinLayoutEntity.const_353)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_359 == SkinLayoutEntity.const_572)
                  {
                  ...
                  else if(_loc10_.var_359 == SkinLayoutEntity.const_353 || _loc10_.var_356 == SkinLayoutEntity.const_353)
                  {
                  ...
                  {
                     this.var_284.a = REGION.width;
                     this.var_284.d = REGION.height;
                     this.var_284.tx = REGION.x;
                     this.var_284.ty = REGION.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_284,ALPHA);
                  }
                  else
                  {
                     this.var_284.a = 0 / _loc18_.width;
                     this.var_284.d = 0 / _loc18_.height;
                     this.var_284.tx = 0;
                     this.var_284.ty = 0;
                     _loc31_ = new BitmapData(REGION.width,REGION.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_284);
                     _loc32_ = new BitmapData(REGION.width,REGION.height,true,0);
                     _loc32_.draw(_loc19_,this.var_284,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_356 == SkinLayoutEntity.const_371)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_359 == SkinLayoutEntity.const_371)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_953[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_952[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
