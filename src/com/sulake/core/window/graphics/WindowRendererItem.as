package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_704:uint = 0;
      
      private static const const_1113:uint = 1;
      
      private static const const_1114:uint = 2;
       
      
      private var var_136:BitmapData;
      
      private var var_185:WindowRenderer;
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1114) : uint(const_704);
         var _loc6_:Boolean = this.var_205.width > 0 && this.var_205.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_1059))
            {
               _loc5_ = const_1113;
            }
         }
         ...
         if(_loc5_ != const_704)
         {
            this.var_1607 = this.var_1059;
            _loc4_ = param1.fetchDrawBuffer() as BitmapData;
            if(_loc4_ != null)
            {
               _loc4_.lock();
               if(_loc5_ == const_1113)
               {
                  _loc6_ = true;
                  ...
                  if(this.var_705)
                  {
                     ...
                     _loc7_.draw(param1,this.var_136,this.var_136.rect,this.var_1059,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_32))
                  {
                     this.var_1166.tx = param2.x;
                     this.var_1166.ty = param2.y;
                     this.var_853.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_136,this.var_1166,this.var_853,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1607;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_1292:
               ...
               break;
            case WindowRedrawFlag.const_804:
               this.var_1059 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_1059 != this.var_1607)
               {
                  this.var_705 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_1269:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  this.var_705 = true;
                  _loc4_ = true;
