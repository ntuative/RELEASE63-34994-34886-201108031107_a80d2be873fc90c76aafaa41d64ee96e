package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1080:uint = 8;
      
      private static const const_1526:String = "skin";
      
      private static const const_1522:String = "bitmap";
      
      private static const const_1527:String = "fill";
      
      private static const const_1524:String = "text";
      
      private static const const_1525:String = "label";
      
      private static const const_1523:String = "shape";
      ...
      private var var_991:Dictionary;
      
      private var var_458:Dictionary;
      
      private var var_1911:Dictionary;
      
      private var var_2555:Dictionary;
      
      private var var_2557:Dictionary;
      
      private var var_2556:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_992 = new Dictionary();
         this.var_991 = new Dictionary();
         this.var_1911 = new Dictionary();
         this.var_2555 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1911,this.var_2555);
         this.var_2557 = new Dictionary();
         this.var_2556 = new Dictionary();
         StateCodeTable.fillTables(this.var_2557,this.var_2556);
         this.var_458 = new Dictionary();
         this.var_458[const_1526] = BitmapSkinRenderer;
         this.var_458[const_1522] = BitmapDataRenderer;
         this.var_458[const_1527] = FillSkinRenderer;
         this.var_458[const_1524] = TextSkinRenderer;
         this.var_458[const_1525] = LabelRenderer;
         this.var_458[const_1523] = ShapeSkinRenderer;
         this.var_458[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_458[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_363 == null)
         {
            var_363 = new Array();
            var_363.push(WindowState.const_72);
            var_363.push(WindowState.const_94);
            var_363.push(WindowState.const_95);
            var_363.push(WindowState.const_57);
            var_363.push(WindowState.const_89);
            var_363.push(WindowState.const_92);
            var_363.push(WindowState.const_91);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_3064 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1911[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_992[param1] == null)
         {
            this.var_992[param1] = new Array(const_1080);
         }
         this.var_992[param1][param2] = param3;
         if(this.var_991[param1] == null)
         {
            this.var_991[param1] = new Array(const_1080);
         }
         this.var_991[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_992[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_991[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_104)
