package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_89:String = "hovering";
      
      public static const const_57:String = "selected";
      
      public static const const_95:String = "pressed";
      
      public static const const_94:String = "disabled";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_356 = SkinLayoutEntity.const_659;
                  break;
               case "move":
                  _loc5_.var_356 = SkinLayoutEntity.const_371;
                  break;
               case "strech":
                  _loc5_.var_356 = SkinLayoutEntity.const_619;
                  break;
               case "tiled":
                  _loc5_.var_356 = SkinLayoutEntity.const_353;
                  break;
               case "center":
                  _loc5_.var_356 = SkinLayoutEntity.const_572;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_359 = SkinLayoutEntity.const_659;
                  break;
               case "move":
                  _loc5_.var_359 = SkinLayoutEntity.const_371;
                  break;
               case "strech":
                  _loc5_.var_359 = SkinLayoutEntity.const_619;
                  break;
               case "tiled":
                  _loc5_.var_359 = SkinLayoutEntity.const_353;
                  break;
               case "center":
                  _loc5_.var_359 = SkinLayoutEntity.const_572;
            }
         }
