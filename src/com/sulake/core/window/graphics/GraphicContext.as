package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_2046:uint = 0;
      
      public static const const_995:uint = 1;
      
      public static const const_1203:uint = 2;
      
      public static const const_912:uint = 4;
      
      public static const const_2039:uint = 8;
      
      public static const const_2057:uint = 16;
      
      public static const const_2272:uint = 64;
      
      public static const const_2245:uint = 128;
      
      public static const const_1385:uint = 256;
      
      protected static var var_620:uint = 0;
      
      protected static var var_365:uint = 0;
       
      
      protected var var_236:DisplayObjectContainer;
      
      protected var var_2291:Boolean;
      
      protected var var_955:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1203:
               ...
               break;
            case GraphicContext.const_2039:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_2057:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_912:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1385:
               break;
            case GraphicContext.const_2046:
               break;
            default:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_236.numChildren > 0)
               {
                  this.var_236.removeChildAt(0);
               }
            }
            this.var_236 = null;
            while(numChildren > 0)
         ...
         if(this.var_955)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2291,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2291,16777215);
                  }
                  var_365 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_236 == null)
         {
            ...
            this.var_236.name = this.name + " - Child Container";
      ...
      {
         return this.var_236 != null ? int(this.var_236.numChildren) : 0;
      }
