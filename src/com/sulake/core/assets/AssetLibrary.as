package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1346:String = "AssetLibraryReady";
      
      public static const const_962:String = "AssetLibraryLoaded";
      
      public static const const_1800:String = "AssetLibraryUnloaded";
      
      public static const const_1954:String = "AssetLibraryLoadError";
      
      private static const const_703:String = "name";
      
      private static const const_1112:String = "asset";
      ...
      private static var var_343:Dictionary;
      
      private static var var_2041:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_577:uint = 0;
      
      private static var var_1054:Array = new Array();
      ...
      private var var_482:uint;
      
      private var var_44:LibraryLoader;
      
      private var var_699:Class;
      
      private var var_1055:Dictionary;
      
      private var var_181:Dictionary;
      
      private var var_1056:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_577;
         this.var_481 = new Dictionary(false);
         this.var_576 = new Dictionary(false);
         this.var_1055 = new Dictionary(false);
         this.var_181 = new Dictionary(false);
         var_1054.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_698 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1111);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1112);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_703);
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_698 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1054.splice(var_1054.indexOf(this),1);
            --var_577;
            this.var_576 = null;
            this.var_1055 = null;
            this.var_181 = null;
      ...
      {
         if(this.var_698 == param1.url && this.var_1053)
         {
            if(!this.var_1056 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_699);
            }
      ...
      public function unload() : void
      {
         ...
         {
            _loc2_ = this.var_576[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_576[_loc1_];
         }
         for(_loc1_ in this.var_181)
         {
            delete this.var_181[_loc1_];
         }
         for(_loc1_ in this.var_1055)
         {
            delete this.var_1055[_loc1_];
         }
         if(this.var_44 != null)
         {
            this.var_44.dispose();
         ...
         this.var_1053 = false;
         this.var_698 = null;
         dispatchEvent(new Event(AssetLibrary.const_1800));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1055[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_576[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1379,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1404,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1383,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_576[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_576[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_181[struct.assetName] == null)
                  {
                     ++this.var_482;
                     this.var_480.push(struct.assetName);
                  }
                  this.var_181[struct.assetName] = asset;
               }
               else
               {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_576[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_181[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function getAssetByContent(param1:Object) : IAsset
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for(_loc2_ in this.var_181)
         {
            _loc3_ = this.var_181[_loc2_];
      ...
      {
         return this.var_181[param1] != null || (this.var_699 != null ? this.var_699[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_181[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            ...
            this.var_181[param1] = param2;
            if(param2 is ILazyAsset)
            {
               var_2041.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_343.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_343[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_481.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_481[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_343[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         return AssetTypeDeclaration(this.var_481[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_343)
            {
               _loc3_ = AssetTypeDeclaration(var_343[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_481)
         {
            _loc3_ = AssetTypeDeclaration(this.var_481[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_343)
            {
               _loc4_ = AssetTypeDeclaration(var_343[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_481)
         {
            _loc4_ = AssetTypeDeclaration(this.var_481[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_699 = _loc2_.resource;
         this.var_698 = _loc2_.url;
         if(this.var_1056)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_699);
         }
         this.var_1053 = true;
         dispatchEvent(new Event(AssetLibrary.const_962));
         dispatchEvent(new Event(AssetLibrary.const_1346));
         if(this.var_1056)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1954));
         this.var_44 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1111);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1112);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_703) && _loc3_.attribute(const_703).toString() == param1)
                  {
                     _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_698 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_699[param1]);
