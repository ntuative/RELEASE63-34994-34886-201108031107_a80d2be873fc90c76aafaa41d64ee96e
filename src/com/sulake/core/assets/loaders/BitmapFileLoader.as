package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1158 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_44 = new Loader();
         this.var_1157 = new LoaderContext();
         this.var_1157.checkPolicyFile = true;
         ...
         {
            this.var_44.load(param2,this.var_1157);
         }
      }
      ...
      {
         this.var_1158 = param1.url;
         var_362 = 0;
         this.var_44.load(param1,this.var_1157);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_362 < var_3077)
            {
               ...
               this.var_44.load(new URLRequest(this.var_1158 + (this.var_1158.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_362),this.var_1157);
               return true;
            }
         }
         return false;
