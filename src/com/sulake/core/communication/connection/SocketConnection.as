package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_2015:int = 10000;
      ...
      private var var_531:ByteArray;
      
      private var var_1195:IEncryption;
      
      private var var_783:IProtocol;
      
      private var _id:String;
      
      private var var_1196:IMessageClassManager;
      
      private var var_298:ICoreCommunicationManager;
      
      private var var_530:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_298 = param2;
         this.var_531 = new ByteArray();
         this.var_1196 = new MessageClassManager();
         this.var_82 = new Socket();
         this.var_212 = new Timer(const_2015,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         ...
         if(this.var_530)
         {
            this.var_530.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_212.start();
         this.var_782 = getTimer();
      ...
      public function addMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_298.addConnectionMessageEvent(this._id,param1);
      }
      ...
      public function removeMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_298.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1196.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         var _loc6_:ByteArray = this.var_783.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_530)
         {
            this.var_530.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1195 != null)
         {
            _loc3_ = this.var_1195.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1196.method_14(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_783.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_783.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1195 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_783.getMessages(this.var_531,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_530)
               {
                  this.var_530.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1196.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = this.var_298.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = this.var_298.getMessageParser(parserClass);
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_531,offset);
               this.var_531 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_531.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_531.writeByte(this.var_82.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_212.stop();
         this.var_1805 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_782));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1805 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_782));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_782));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_782));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_782));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_782));
