package com.sulake.core.localization
{
   ...
   public class Localization implements ILocalization
   {
      ...
      private var var_1462:Dictionary;
      ...
      private function fillParameterValues() : String
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:String = this.var_199;
         for(_loc2_ in this.var_1462)
         {
            _loc3_ = this.var_1462[_loc2_];
