package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1887:String = "float";
      
      public static const const_39:String = "Boolean";
      
      public static const const_1979:String = "bool";
      ...
      private static const const_2107:String = "AnimationAction";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         else
         {
            ...
            else if(_loc5_ == const_257 || _loc5_ == const_166)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_152:
               return uint(param1);
            case const_166:
               return param1.split(const_1530);
            default:
