package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_714:Map = new Map();
      
      private static const const_391:Map = new Map();
      
      private static var var_1350:Boolean = false;
      ...
      {
         return const_714.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1350)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_714.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1350 = true;
         }
