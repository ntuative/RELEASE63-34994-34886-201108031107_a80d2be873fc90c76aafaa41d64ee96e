package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2074:uint = 1;
      
      protected static const const_2072:uint = 2;
      
      protected static const const_2073:uint = 4;
      
      protected static const const_2075:uint = 3;
      
      protected static const name_5:uint = 7;
      
      public static const const_2063:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1252:Boolean = false;
      
      public static const const_1860:int = 2;
      
      private static var var_1067:Array = new Array();
      
      private static var var_859:Array = new Array();
      ...
      protected var var_265:URLRequest;
      
      protected var _manifest:XML;
      
      protected var var_699:Class;
      
      protected var var_517:uint = 0;
      
      protected var _name:String;
      
      protected var var_1162:Boolean = false;
      
      protected var _debug:Boolean = false;
      
      protected var var_1163:Boolean = false;
      
      protected var var_3080:String = "";
      
      protected var var_3078:String = "";
      
      protected var var_2287:int;
      
      protected var var_1437:int;
      
      protected var var_1436:int;
      
      protected var var_3148:uint = 0;
      
      protected var var_3079:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         if(const_1252)
         {
            if(var_1067.indexOf(param1) == -1)
            {
               var_1067.push(param1);
            }
            throttle();
         }
         else
         {
            param1.var_44.load(param1.var_265,param1._context);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1252)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_859[_loc2_] as LibraryLoader;
            ...
            while(var_859.length < const_1860 && false)
            {
               _loc1_ = var_1067.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_859.push(_loc1_);
                  _loc1_.var_44.load(_loc1_.var_265,_loc1_._context);
               }
            }
         }
      }
      ...
      {
         return !!this.var_265 ? this.var_265.url : null;
      }
      ...
      {
         return !!this.var_1162 ? uint(this.var_1437 - this.var_2287) : uint(getTimer() - this.var_2287);
      }
      ...
      {
         this.var_265 = param1;
         this._name = parseNameFromUrl(this.var_265.url);
         this.var_1162 = false;
      ...
      {
         if(this.var_1163 && !_disposed)
         {
            this.var_1163 = false;
            if(!this.var_1162 && this.var_265)
            {
               this.var_1437 = -1;
               this.var_2287 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1162 && !_disposed && this.var_1436 > 0)
         {
            try
            {
               this.var_44.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_265,const_2063 - this.var_1436);
            if(this.var_3079)
            {
               this.var_265.requestHeaders.push(new URLRequestHeader("pragma","no-cache"));
               this.var_265.requestHeaders.push(new URLRequestHeader("Cache-Control","no-cache"));
               this.var_3079 = false;
            }
            --this.var_1436;
            this.var_517 = 0;
            this.var_44.load(this.var_265,this._context);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_517 = LibraryLoader.name_5;
         ...
         if(this.var_517 == LibraryLoader.const_2075)
         {
         ...
         if(this.var_517 == LibraryLoader.name_5)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_699 = this.getDefinition(this._name) as Class;
         if(this.var_699 == null)
         {
            if(!this.retry())
            {
               this.failure("Failed to find resource class \"" + this._name + "\" from library " + this.var_265.url + "!");
            }
            return false;
         }
         ...
         try
         {
            xmlClass = this.var_699.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
