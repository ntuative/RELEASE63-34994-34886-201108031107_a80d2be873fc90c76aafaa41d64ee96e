package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1605:int = 128;
      
      private var var_1604:Boolean = false;
      
      private var var_3110:Point;
      ...
      {
         if(param1 != this.var_2046 || param2 != this.var_2045)
         {
      ...
      {
         if(this.var_1605 > 255 || bitmapData == null)
         {
            return false;
         }
