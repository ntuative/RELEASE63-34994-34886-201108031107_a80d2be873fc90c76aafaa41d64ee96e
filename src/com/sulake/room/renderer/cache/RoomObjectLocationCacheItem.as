package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      private var var_2864:int = -1;
      
      private var var_1324:Vector3d;
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1754 || param1.getUpdateID() != this.var_2864)
         {
            this.var_2864 = param1.getUpdateID();
            if(param2.updateId != this.var_1754 || _loc4_.x != this.var_1324.x || _loc4_.y != this.var_1324.y || _loc4_.z != this.var_1324.z)
            {
               this.var_1754 = param2.updateId;
               this.var_1324.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2863 = _loc3_;
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  this.var_397.assign(_loc5_);
                  if(_loc8_ != null)
                  {
                     this.var_397.z = _loc8_.z;
                  }
               }
               else
               {
            ...
            this.var_397.x = Math.round(this.var_397.x);
            this.var_397.y = Math.round(this.var_397.y);
         }
         return this.var_397;
      }
   }
