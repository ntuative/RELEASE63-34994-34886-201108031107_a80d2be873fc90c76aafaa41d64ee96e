package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_600:Number = 64;
      
      public static const const_1258:Number = 32;
      ...
      private var var_1217:Vector3d;
      
      private var var_455:Vector3d;
      
      private var _direction:Vector3d;
      
      private var var_1218:Vector3d;
      ...
      private var var_1863:Number = 1.0;
      
      private var var_1862:Number = 1.0;
      
      private var var_1864:Number = 1.0;
      
      private var var_102:Vector3d;
      
      private var var_454:Vector3d;
      
      private var var_3093:Number = -500.0;
      
      private var var_3094:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1217 = new Vector3d();
         this.var_455 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1218 = new Vector3d();
         this.var_1863 = 1;
         this.var_1862 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1864 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_455.assign(this.var_102);
         this.var_455.x *= this.var_452;
         this.var_455.y *= this.var_451;
      ...
      {
         if(this.var_452 != param1 * this.var_1863)
         {
            this.var_452 = param1 * this.var_1863;
            ++this.var_173;
         }
      }
      ...
      {
         if(this.var_451 != param1 * this.var_1862)
         {
            this.var_451 = param1 * this.var_1862;
            ++this.var_173;
         }
      }
      ...
      {
         if(this.var_453 != param1 * this.var_1864)
         {
            this.var_453 = param1 * this.var_1864;
            ++this.var_173;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_102.x;
         var _loc3_:Number = this.var_102.y;
         var _loc4_:Number = this.var_102.z;
         this.var_102.assign(param1);
         this.var_102.x /= this.var_452;
         this.var_102.y /= this.var_451;
         this.var_102.z /= this.var_453;
         if(this.var_102.x != _loc2_ || this.var_102.y != _loc3_ || this.var_102.z != _loc4_)
         {
            ++this.var_173;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_183.assign(_loc24_);
            this.var_184.assign(_loc25_);
            this.var_1217.assign(this.var_184);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_183.assign(_loc19_);
            this.var_184.assign(_loc20_);
            this.var_1217.assign(this.var_184);
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_541 != null)
         {
            ...
            this.var_541.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_541.add(_loc3_,_loc4_);
            ++this.var_173;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_541 != null)
         {
            ...
            return this.var_541.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1218.assign(_loc22_);
         }
         else
         {
            this.var_1218.assign(_loc17_);
         }
         ++this.var_173;
      }
      ...
      {
         if(param1 == null || this.var_184 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_184,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_183);
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_184);
         return new Vector3d(_loc2_,_loc3_,_loc4_);
      }
      
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,this.var_102);
         _loc2_.x *= this.var_452;
         _loc2_.y *= this.var_451;
         _loc2_.z *= this.var_453;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1218);
         if(_loc3_ < this.var_3093 || _loc3_ > this.var_3094)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_183);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         var _loc6_:IVector3d = this.getDisplacenent(param1);
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,this.var_102);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_452;
            _loc2_.y *= this.var_451;
            _loc2_.z *= this.var_453;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1218);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_183,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_102.x * this.var_452,this.var_102.y * this.var_451,this.var_102.z * this.var_453);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_184;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_452,param2.y * this.var_451,param2.z * this.var_453);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_452,param3.y * this.var_451,param3.z * this.var_453);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_452,param4.y * this.var_451,param4.z * this.var_453);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1258;
         }
         else
         {
            this.scale = const_600;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_600;
      }
